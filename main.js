...
$(function() {
    ...
    $(document.body).on("click", '[data-action="addtocart"]', function(e) {
        ...
        if (!t.length)
            return void swal("Товар не найден", "Кнопка должна находиться в карточке товара.", "error");
                                                    ...
                                                    e.ajaxSubmit({
                                                        ...
                                                        success: function(r) {
                                                            try {
                                                                ...
                                                                t.find("span.state").text("Файл загружен"),
                                                                e.remove(),
                                                                n()
                                                            } catch (i) {
                                                        ...
                                                        error: function(i) {
                                                            try {
                                                                return r("Ошибка загрузки!", 400 === i.status ? i.responseText : null),
                                                                t.find("span.state").text("Выберите файл..."),
                                                                t.data("result", null),
                                                                e.remove(),
                                                                n()
                                                            } catch (o) {
