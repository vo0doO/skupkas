...
!function(e, t) {
    ...
    function a() {
        me.addEventListener ? (me.removeEventListener("DOMContentLoaded", l, !1),
        e.removeEventListener("load", l, !1)) : (me.detachEvent("onreadystatechange", l),
    ...
    function c(e, t, n, r) {
        if (oe.acceptData(e)) {
            var i, o, a = oe.expando, l = e.nodeType, s = l ? oe.cache : e, u = l ? e[a] : e[a] && a;
            if (u && s[u] && (r || s[u].data) || void 0 !== n || "string" != typeof t)
                return u || (u = l ? e[a] = V.pop() || oe.guid++ : a),
                s[u] || (s[u] = l ? {} : {
                    toJSON: oe.noop
                }),
                "object" != typeof t && "function" != typeof t || (r ? s[u] = oe.extend(s[u], t) : s[u].data = oe.extend(s[u].data, t)),
                o = s[u],
                r || (o.data || (o.data = {}),
                o = o.data),
    ...
    function d(e, t, n) {
        if (oe.acceptData(e)) {
            var r, i, o = e.nodeType, a = o ? oe.cache : e, l = o ? e[oe.expando] : oe.expando;
            if (a[l]) {
                ...
                (n || (delete a[l].data,
                u(a[l]))) && (o ? oe.cleanData([e], !0) : re.deleteExpando || a != a.window ? delete a[l] : a[l] = null)
            }
        }
    }
    function f() {
    ...
    function y(e, t) {
        var n, r, i = 0, o = typeof e.getElementsByTagName !== ke ? e.getElementsByTagName(t || "*") : typeof e.querySelectorAll !== ke ? e.querySelectorAll(t || "*") : void 0;
        if (!o)
            for (o = [],
            n = e.childNodes || e; null != (r = n[i]); i++)
                !t || oe.nodeName(r, t) ? o.push(r) : oe.merge(o, y(r, t));
    ...
    function T(e, t) {
        if (1 === t.nodeType && oe.hasData(e)) {
            var n, r, i, o = oe._data(e), a = oe._data(t, o), l = o.events;
            if (l) {
                delete a.handle,
                a.events = {};
                for (n in l)
    ...
    function P(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            re.html5Clone && e.innerHTML && !oe.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === n && Ae.test(e.type) ? (t.defaultChecked = t.checked = e.checked,
    ...
    function _(e, t) {
        for (var n, r, i, o = [], a = 0, l = e.length; a < l; a++)
            ...
            "" === r.style.display && Ye(r) && (o[a] = oe._data(r, "olddisplay", C(r.nodeName)))) : o[a] || (i = Ye(r),
    ...
    function O(e, t, n) {
        var r, i, o, a, l, s, u, c, d = this, f = {}, p = e.style, h = e.nodeType && Ye(e), m = oe._data(e, "fxshow");
        n.queue || (l = oe._queueHooks(e, "fx"),
        ...
        c = C(e.nodeName),
        "none" === u && (u = c),
        "inline" === u && "none" === oe.css(e, "float") && (re.inlineBlockNeedsLayout && "inline" !== c ? p.zoom = 1 : p.display = "inline-block")),
    ...
    function M(e, t, n) {
        var r, i, o = 0, a = bt.length, l = oe.Deferred().always(function() {
            delete s.elem
        }), s = function() {
            if (i)
                return !1;
            for (var t = ht || $(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, s = u.tweens.length; a < s; a++)
                u.tweens[a].run(o);
            return l.notifyWith(e, [u, o, n]),
            o < 1 && s ? n : (l.resolveWith(e, [u]),
            !1)
        }, u = l.promise({
            elem: e,
            props: oe.extend({}, t),
            ...
            stop: function(t) {
                ...
                for (i = !0; n < r; n++)
                    u.tweens[n].run(1);
                return t ? l.resolveWith(e, [u, t]) : l.rejectWith(e, [u, t]),
                this
            }
        }), c = u.props;
    ...
    function z(e, t, n, r) {
        function i(l) {
            ...
            oe.each(e[l] || [], function(e, l) {
                var u = l(t, n, r);
                return "string" != typeof u || a || o[u] ? a ? !(s = u) : void 0 : (t.dataTypes.unshift(u),
                i(u),
                !1)
            }),
            s
            ...
            o = c.shift())
                if ("*" === o)
                    ...
                    !a)
                        for (i in u)
                            if (l = i.split(" "),
                            l[1] === o && (a = u[s + " " + l[0]] || u["* " + l[0]])) {
                                a === !0 ? a = u[i] : u[i] !== !0 && (o = l[0],
                                c.unshift(l[1]));
                                break
                            }
                    if (a !== !0)
        ...
        l--); l < s; l++)
            if (null != (i = arguments[l]))
                for (r in i)
                    e = a[r],
                    n = i[r],
                    a !== n && (u && n && (oe.isPlainObject(n) || (t = oe.isArray(n))) ? (t ? (t = !1,
    ...
    var ce = function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : z) !== Q && A(t),
            t = t || Q,
            n = n || [],
            !e || "string" != typeof e)
                return n;
        ...
        function f(e, n) {
            ...
            s = [],
            u = k.preFilter; l; ) {
                r && !(i = ue.exec(l)) || (i && (l = l.slice(i[0].length) || l),
                s.push(o = [])),
                r = !1,
                (i = ce.exec(l)) && (r = i.shift(),
                o.push({
                    value: r,
                    type: i[0].replace(se, " ")
                }),
                l = l.slice(r.length));
                for (a in k.filter)
                    !(i = he[a].exec(l)) || u[a] && !(i = u[a](i)) || (r = i.shift(),
                    o.push({
                        value: r,
                        type: a,
                        matches: i
        ...
        function v(e, t, n, i, o, a) {
            ...
            o && !o[L] && (o = v(o, a)),
            r(function(r, a, l, s) {
                var u, c, d, f = [], p = [], h = a.length, m = r || w(t || "*", l.nodeType ? [l] : l, []), v = !e || !r && t ? m : y(m, f, e, l, s), g = n ? o || (r ? e : h || i) ? [] : a : v;
                if (n && n(v, g, l, s),
                i)
                    for (u = y(g, p),
                    i(u, [], l, s),
                ...
                if (r) {
                    if (o || e) {
                        ...
                        for (c = g.length; c--; )
                            (d = g[c]) && (u = o ? te.call(r, d) : f[c]) > -1 && (r[u] = !(a[u] = d))
                    }
                } else
                    g = y(g === a ? g.splice(h, g.length) : g),
                    o ? o(null, a, g, s) : Z.apply(a, g)
            })
        }
        function g(e) {
            for (var t, n, r, i = e.length, o = k.relative[e[0].type], a = o || k.relative[" "], l = o ? 1 : 0, s = h(function(e) {
                return e === t
            }, a, !0), u = h(function(e) {
                return te.call(t, e) > -1
            }, a, !0), c = [function(e, n, r) {
                return !o && (r || n !== _) || ((t = n).nodeType ? s(e, n, r) : u(e, n, r))
            }
            ]; l < i; l++)
                if (n = k.relative[e[l].type])
                    c = [h(m(c), n)];
                else {
                    if (n = k.filter[e[l].type].apply(null, e[l].matches),
                    n[L]) {
                        for (r = ++l; r < i && !k.relative[e[r].type]; r++)
                            ;
                        return v(l > 1 && m(c), l > 1 && p(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
                        })).replace(se, "$1"), n, l < r && g(e.slice(l, r)), r < i && g(e = e.slice(r)), r < i && p(e))
                    }
                    c.push(n)
                }
            return m(c)
        ...
        function b(e, n) {
            var i = n.length > 0
              ...
              , a = function(r, a, l, s, u) {
                var c, d, f, p = 0, h = "0", m = r && [], v = [], g = _, b = r || o && k.find.TAG("*", u), w = B += null == g ? 1 : Math.random() || .1, x = b.length;
        ...
        var T, P, k, C, j, S, _, Y, E, A, Q, $, I, D, O, N, M, L = "sizzle" + -new Date, z = e.document, B = 0, R = 0, F = n(), q = n(), H = n(), U = function(e, t) {
            return e === t && (E = !0),
            0
        }, W = "undefined", V = 1 << 31, X = {}.hasOwnProperty, J = [], K = J.pop, G = J.push, Z = J.push, ee = J.slice, te = J.indexOf || function(e) {
            for (var t = 0, n = this.length; t < n; t++)
                if (this[t] === e)
                    return t;
            return -1
        }
        , ne = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", re = "[\\x20\\t\\r\\n\\f]", ie = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", oe = ie.replace("w", "w#"), ae = "\\[" + re + "*(" + ie + ")" + re + "*(?:([*^$|!~]?=)" + re + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + oe + ")|)|)" + re + "*\\]", le = ":(" + ie + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + ae.replace(3, 8) + ")*)|.*)\\)|)", se = new RegExp("^" + re + "+|((?:^|[^\\\\])(?:\\\\.)*)" + re + "+$","g"), ue = new RegExp("^" + re + "*," + re + "*"), ce = new RegExp("^" + re + "*([>+~]|" + re + ")" + re + "*"), de = new RegExp("=" + re + "*([^\\]'\"]*?)" + re + "*\\]","g"), fe = new RegExp(le), pe = new RegExp("^" + oe + "$"), he = {
            ID: new RegExp("^#(" + ie + ")"),
            CLASS: new RegExp("^\\.(" + ie + ")"),
        ...
        }, me = /^(?:input|select|textarea|button)$/i, ye = /^h\d$/i, ve = /^[^{]+\{\s*\[native \w/, ge = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, be = /[+~]/, we = /'|\\/g, xe = new RegExp("\\\\([\\da-f]{1,6}" + re + "?|(" + re + ")|.)","ig"), Te = function(e, t, n) {
            var r = "0x" + t - 65536;
        ...
        A = t.setDocument = function(e) {
            ...
            (P.qsa = ve.test(n.querySelectorAll)) && (i(function(e) {
                ...
                e.querySelectorAll("[t^='']").length && D.push("[*^$]=" + re + "*(?:''|\"\")"),
            ...
            (P.matchesSelector = ve.test(N = $.webkitMatchesSelector || $.mozMatchesSelector || $.oMatchesSelector || $.msMatchesSelector)) && i(function(e) {
            ...
            M = t || ve.test($.contains) ? function(e, t) {
            ...
            U = t ? function(e, t) {
                ...
                1 & r || !P.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === z && M(z, e) ? -1 : t === n || t.ownerDocument === z && M(z, t) ? 1 : Y ? te.call(Y, e) - te.call(Y, t) : 0 : 4 & r ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return E = !0,
                    0;
                var r, i = 0, o = e.parentNode, l = t.parentNode, s = [e], u = [t];
                if (!o || !l)
                    return e === n ? -1 : t === n ? 1 : o ? -1 : l ? 1 : Y ? te.call(Y, e) - te.call(Y, t) : 0;
                if (o === l)
                    return a(e, t);
        ...
        t.attr = function(e, t) {
            ...
            return void 0 !== r ? r : P.attributes || !I ? e.getAttribute(t) : (r = e.getAttributeNode(t)) && r.specified ? r.value : null
        }
        ,
        t.error = function(e) {
        ...
        k = t.selectors = {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, s) {
                        var u, c, d, f, p, h, m = o !== a ? "nextSibling" : "previousSibling", y = t.parentNode, v = l && t.nodeName.toLowerCase(), g = !s && !l;
                        if (y) {
                            if (o) {
                                for (; m; ) {
                                    for (d = t; d = d[m]; )
                                        if (l ? d.nodeName.toLowerCase() === v : 1 === d.nodeType)
                                            return !1;
                            ...
                            a && g) {
                                ...
                                p = u[0] === B && u[1],
                                f = u[0] === B && u[2],
                                d = p && y.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop(); )
                                ...
                                for (; (d = ++p && d && d[m] || (f = p = 0) || h.pop()) && ((l ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (g && ((d[L] || (d[L] = {}))[e] = [B, f]),
                                d !== t)); )
                                    ;
                            return f -= i,
                            f === r || f % r === 0 && f / r >= 0
        ...
        ,
        P.sortStable = L.split("").sort(U).join("") === L,
    ...
    var he, me = e.document, ye = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ve = oe.fn.init = function(e, t) {
        var n, r;
        if (!e)
            return this;
        if ("string" == typeof e) {
    ...
    oe.Callbacks = function(e) {
        ...
        var t, n, r, i, a, l, s = [], u = !e.once && [], c = function(o) {
            for (n = e.memory && o,
            r = !0,
            a = l || 0,
            l = 0,
            ...
            t = !1,
            s && (u ? u.length && c(u.shift()) : n ? s = [] : d.disable())
        }, d = {
            add: function() {
                if (s) {
                    var r = s.length;
    ...
    oe.extend({
        ...
        when: function(e) {
            var t, n, r, i = 0, o = X.call(arguments), a = o.length, l = 1 !== a || e && oe.isFunction(e.promise) ? a : 0, s = 1 === l ? e : oe.Deferred(), u = function(e, n, r) {
                return function(i) {
                    n[e] = this,
                    r[e] = arguments.length > 1 ? X.call(arguments) : i,
                    r === t ? s.notifyWith(n, r) : --l || s.resolveWith(n, r)
                }
            };
            if (a > 1)
                for (t = new Array(a),
                n = new Array(a),
                r = new Array(a); i < a; i++)
                    o[i] && oe.isFunction(o[i].promise) ? o[i].promise().done(u(i, r, o)).fail(s.reject).progress(u(i, n, t)) : --l;
    ...
    oe.fn.extend({
        ...
        promise: function(e, t) {
            var n, r = 1, i = oe.Deferred(), o = this, a = this.length, l = function() {
                --r || i.resolveWith(o, [o])
            };
    ...
    oe.event = {
            ...
            if (y && (c = y.events)) {
                ...
                u = t.length; u--; )
                    ...
                    p) {
                        ...
                        s = o = f.length; o--; )
                            a = f[o],
                            !i && m !== a.origType || n && n.guid !== a.guid || l && !l.test(a.namespace) || r && r !== a.selector && ("**" !== r || !a.selector) || (f.splice(o, 1),
                            a.selector && f.delegateCount--,
                            d.remove && d.remove.call(e, a));
                        s && !f.length && (d.teardown && d.teardown.call(e, h, y.handle) !== !1 || oe.removeEvent(e, p, y.handle),
                        delete c[p])
                    } else
                        for (p in c)
        ...
        trigger: function(t, n, r, i) {
            var o, a, l, s, u, c, d, f = [r || me], p = te.call(t, "type") ? t.type : t, h = te.call(t, "namespace") ? t.namespace.split(".") : [];
            if (l = c = r = r || me,
            3 !== r.nodeType && 8 !== r.nodeType && !De.test(p + oe.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."),
            p = h.shift(),
            h.sort()),
            a = p.indexOf(":") < 0 && "on" + p,
        ...
        dispatch: function(e) {
            e = oe.event.fix(e);
            var t, n, r, i, o, a = [], l = X.call(arguments), s = (oe._data(this, "events") || {})[e.type] || [], u = oe.event.special[e.type] || {};
            if (l[0] = e,
            e.delegateTarget = this,
            !u.preDispatch || u.preDispatch.call(this, e) !== !1) {
                for (a = oe.event.handlers.call(this, e, s),
                ...
                for (; s != this; s = s.parentNode || this)
                    if (1 === s.nodeType && (s.disabled !== !0 || "click" !== e.type)) {
                        ...
                        o = 0; o < l; o++)
                            r = t[o],
                            n = r.selector + " ",
                            void 0 === i[n] && (i[n] = r.needsContext ? oe(n, this).index(s) >= 0 : oe.find(n, this, null, [s]).length),
                            i[n] && i.push(r);
                        i.length && a.push({
                            elem: s,
                            handlers: i
        ...
        fix: function(e) {
            ...
            for (a || (this.fixHooks[i] = a = Ie.test(i) ? this.mouseHooks : $e.test(i) ? this.keyHooks : {}),
    ...
    : function(e, t, n) {
        var r = "on" + t;
        e.detachEvent && (typeof e[r] === ke && (e[r] = null),
        e.detachEvent(r, n))
    }
    ,
    ...
    oe.extend({
        clone: function(e, t, n) {
            ...
            if (re.html5Clone || oe.isXMLDoc(e) || !Le.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Ge.innerHTML = e.outerHTML,
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, l, s, u, c, d = e.length, f = m(t), p = [], h = 0; h < d; h++)
                ...
                o || 0 === o)
                    if ("object" === oe.type(o))
                        ...
                        c = Je[s] || Je._default,
                        l.innerHTML = c[1] + o.replace(Be, "<$1></$2>") + c[2],
                        i = c[0]; i--; )
                            l = l.lastChild;
                        if (!re.leadingWhitespace && ze.test(o) && p.push(t.createTextNode(ze.exec(o)[0])),
                        !re.tbody)
                            for (o = "table" !== s || Fe.test(o) ? "<table>" !== c[1] || Fe.test(o) ? 0 : l : l.firstChild,
                            i = o && o.childNodes.length; i--; )
                                oe.nodeName(u = o.childNodes[i], "tbody") && !u.childNodes.length && o.removeChild(u);
                        for (oe.merge(p, l.childNodes),
            ...
            h = 0; o = p[h++]; )
                if ((!r || oe.inArray(o, r) === -1) && (a = oe.contains(o.ownerDocument, o),
        ...
        cleanData: function(e, t) {
            for (var n, r, i, o, a = 0, l = oe.expando, s = oe.cache, u = re.deleteExpando, c = oe.event.special; null != (n = e[a]); a++)
                if ((t || oe.acceptData(n)) && (i = n[l],
                o = i && s[i])) {
                    if (o.events)
                        for (r in o.events)
                            c[r] ? oe.event.remove(n, r) : oe.removeEvent(n, r, o.handle);
                    s[i] && (delete s[i],
                    u ? delete n[l] : typeof n.removeAttribute !== ke ? n.removeAttribute(l) : n[l] = null,
                    V.push(i))
                }
        }
    }),
    oe.fn.extend({
        ...
        remove: function(e, t) {
            for (var n, r = e ? oe.filter(e, this) : this, i = 0; null != (n = r[i]); i++)
                ...
                n.parentNode && (t && oe.contains(n.ownerDocument, n) && x(y(n, "script")),
            ...
            return Ee(this, function(e) {
                ...
                if ("string" == typeof e && !He.test(e) && (re.htmlSerialize || !Le.test(e)) && (re.leadingWhitespace || !ze.test(e)) && !Je[(Re.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < r; n++)
                            t = this[n] || {},
                            1 === t.nodeType && (oe.cleanData(y(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (i) {}
                }
        ...
        domManip: function(e, t) {
            e = J.apply([], e);
            var n, r, i, o, a, l, s = 0, u = this.length, c = this, d = u - 1, f = e[0], p = oe.isFunction(f);
            ...
            if (u && (l = oe.buildFragment(e, this[0].ownerDocument, !1, this),
            n = l.firstChild,
            1 === l.childNodes.length && (l = n),
            n)) {
                for (o = oe.map(y(l, "script"), b),
                i = o.length; s < u; s++)
                    r = l,
                    s !== d && (r = oe.clone(r, !0, !0),
                    i && oe.merge(o, y(r, "script"))),
                    t.call(this[s], r, s);
                if (i)
                    ...
                    s = 0; s < i; s++)
                        r = o[s],
                        We.test(r.type || "") && !oe._data(r, "globalEval") && oe.contains(a, r) && (r.src ? oe._evalUrl && oe._evalUrl(r.src) : oe.globalEval((r.text || r.textContent || r.innerHTML || "").replace(Xe, "")));
                l = n = null
            }
            return this
        }
    ...
    !function() {
        ...
        re.shrinkWrapBlocks = function() {
            ...
            if (null == t) {
                ...
                t = !1,
                typeof i.style.zoom !== ke && (i.style.cssText = r + ";width:1px;padding:1px;zoom:1",
                i.innerHTML = "<div></div>",
    ...
    function() {
        ...
        var n, r, i, o, a, l, s = me.createElement("div"), u = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px", c = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;padding:0;margin:0;border:0";
    ...
    oe.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, l = oe.camelCase(t), s = e.style;
                if (t = oe.cssProps[l] || (oe.cssProps[l] = S(s, l)),
                ...
                o = "number"),
                null != n && n === n && ("number" !== o || oe.cssNumber[l] || (n += "px"),
    ...
    oe.each(["height", "width"], function(e, t) {
        oe.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return 0 === e.offsetWidth && st.test(oe.css(e, "display")) ? oe.swap(e, dt, function() {
                        return A(e, t, r)
                    }) : A(e, t, r)
            },
            set: function(e, n, r) {
                var i = r && tt(e);
                return Y(e, n, r ? E(e, t, r, re.boxSizing() && "border-box" === oe.css(e, "boxSizing", !1, i), i) : 0)
            }
        }
    }),
    ...
    oe.fx.step = {};
    var ht, mt, yt = /^(?:toggle|show|hide)$/, vt = new RegExp("^(?:([+-])=|)(" + Se + ")([a-z%]*)$","i"), gt = /queueHooks$/, bt = [O], wt = {
        "*": [function(e, t) {
            ...
            select: {
                get: function(e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || i < 0, a = o ? null : [], l = o ? i + 1 : r.length, s = i < 0 ? l : o ? i : 0; s < l; s++)
                        if (n = r[s],
                        (n.selected || s === i) && (re.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !oe.nodeName(n.parentNode, "optgroup"))) {
                            if (t = oe(n).val(),
                            o)
                                return t;
                            a.push(t)
    ...
    var Tt, Pt, kt = oe.expr.attrHandle, Ct = /^(?:checked|selected)$/i, jt = re.getSetAttribute, St = re.input;
    oe.fn.extend({
        attr: function(e, t) {
    ...
    oe.extend({
        attr: function(e, t, n) {
            ...
            if (e && 3 !== o && 8 !== o && 2 !== o)
                return typeof e.getAttribute === ke ? oe.prop(e, t, n) : (1 === o && oe.isXMLDoc(e) || (t = t.toLowerCase(),
                r = oe.attrHooks[t] || (oe.expr.match.bool.test(t) ? Pt : Tt)),
        ...
        removeAttr: function(e, t) {
            ...
            if (o && 1 === e.nodeType)
                for (; n = o[i++]; )
                    r = oe.propFix[n] || n,
                    oe.expr.match.bool.test(n) ? St && jt || !Ct.test(n) ? e[r] = !1 : e[oe.camelCase("default-" + n)] = e[r] = !1 : oe.attr(e, n, ""),
    ...
    Pt = {
        set: function(e, t, n) {
            return t === !1 ? oe.removeAttr(e, n) : St && jt || !Ct.test(n) ? e.setAttribute(!jt && oe.propFix[n] || n, n) : e[oe.camelCase("default-" + n)] = e[n] = !0,
            n
        }
    },
    oe.each(oe.expr.match.bool.source.match(/\w+/g), function(e, t) {
        var n = kt[t] || oe.find.attr;
        kt[t] = St && jt || !Ct.test(t) ? function(e, t, r) {
            var i, o;
            return r || (o = kt[t],
            kt[t] = i,
    ...
    oe.fn.extend({
        addClass: function(e) {
            var t, n, r, i, o, a, l = 0, s = this.length, u = "string" == typeof e && e;
            if (oe.isFunction(e))
        ...
        removeClass: function(e) {
            var t, n, r, i, o, a, l = 0, s = this.length, u = 0 === arguments.length || "string" == typeof e && e;
            if (oe.isFunction(e))
                return this.each(function(t) {
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : oe.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    ...
                    n !== ke && "boolean" !== n || (this.className && oe._data(this, "__className__", this.className),
    ...
    ;
    var It, Dt, Ot = /#.*$/, Nt = /([?&])_=[^&]*/, Mt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Lt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, zt = /^(?:GET|HEAD)$/, Bt = /^\/\//, Rt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Ft = {}, qt = {}, Ht = "*/".concat("*");
    try {
        Dt = location.href
    } catch (Ut) {
    ...
    oe.extend({
        ...
        ajax: function(e, t) {
            function n(e, t, n, r) {
                ...
                w && (oe.etag[o] = w)),
                204 === e || "HEAD" === d.type ? T = "nocontent" : 304 === e ? T = "notmodified" : (T = g.state,
                c = g.data,
                v = g.error,
                i = !v)) : (v = T,
                !e && T || (T = "error",
                ...
                x.status = e,
                x.statusText = (t || T) + "",
                i ? h.resolveWith(f, [c, T, x]) : h.rejectWith(f, [x, T, v]),
                x.statusCode(y),
                y = void 0,
                s && p.trigger(i ? "ajaxSuccess" : "ajaxError", [x, d, i ? c : v]),
                m.fireWith(f, [x, T]),
                s && (p.trigger("ajaxComplete", [x, d]),
                --oe.active || oe.event.trigger("ajaxStop")))
            }
            "object" == typeof e && (t = e,
            e = void 0),
            t = t || {};
            var r, i, o, a, l, s, u, c, d = oe.ajaxSetup({}, t), f = d.context || d, p = d.context && (f.nodeType || f.jquery) ? oe(f) : oe.event, h = oe.Deferred(), m = oe.Callbacks("once memory"), y = d.statusCode || {}, v = {}, g = {}, b = 0, w = "canceled", x = {
                readyState: 0,
            ...
            d.crossDomain = !(!r || r[1] === It[1] && r[2] === It[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (It[3] || ("http:" === It[1] ? "80" : "443")))),
            d.data && d.processData && "string" != typeof d.data && (d.data = oe.param(d.data, d.traditional)),
            z(Ft, d, t, x),
            2 === b)
                return x;
            s = d.global,
            s && 0 === oe.active++ && oe.event.trigger("ajaxStart"),
            d.type = d.type.toUpperCase(),
            d.hasContent = !zt.test(d.type),
            o = d.url,
            d.hasContent || (d.data && (o = d.url += (Qt.test(o) ? "&" : "?") + d.data,
            delete d.data),
            d.cache === !1 && (d.url = Nt.test(o) ? o.replace(Nt, "$1_=" + At++) : o + (Qt.test(o) ? "&" : "?") + "_=" + At++)),
    ...
    oe.ajaxPrefilter("json jsonp", function(t, n, r) {
        ...
        if (l || "jsonp" === t.dataTypes[0])
            ...
            l ? t[l] = t[l].replace(nn, "$1" + i) : t.jsonp !== !1 && (t.url += (Qt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
    ...
    oe.offset = {
        setOffset: function(e, t, n) {
            var r, i, o, a, l, s, u, c = oe.css(e, "position"), d = oe(e), f = {};
    ...
    oe.fn.extend({
        offset: function(e) {
            ...
            if (o)
                ...
                oe.contains(t, i) ? (typeof i.getBoundingClientRect !== ke && (r = i.getBoundingClientRect()),
                n = W(o),
                {
...
function(e) {
    ...
    e.fn.ajaxSubmit = function(t) {
        function n(n) {
            var r, i, o = e.param(n, t.traditional).split("&"), a = o.length, l = [];
            for (r = 0; r < a; r++)
                o[r] = o[r].replace(/\+/g, " "),
                i = o[r].split("="),
                l.push([decodeURIComponent(i[0]), decodeURIComponent(i[1])]);
            return l
        }
        function a(r) {
        ...
        function l(n) {
                ...
                try {
                    if (f.extraData)
                        for (var p in f.extraData)
                            f.extraData.hasOwnProperty(p) && (e.isPlainObject(f.extraData[p]) && f.extraData[p].hasOwnProperty("name") && f.extraData[p].hasOwnProperty("value") ? c.push(e('<input type="hidden" name="' + f.extraData[p].name + '">').val(f.extraData[p].value).appendTo(P)[0]) : c.push(e('<input type="hidden" name="' + p + '">').val(f.extraData[p]).appendTo(P)[0]));
                    f.iframeTarget || y.appendTo("body"),
                    v.attachEvent ? v.attachEvent("onload", l) : v.addEventListener("load", l, !1),
                    setTimeout(t, 15);
                    try {
                        P.submit()
                    } catch (m) {
                    ...
                    n ? P.setAttribute("target", n) : d.removeAttr("target"),
                    e(c).remove()
                }
            }
            function l(t) {
                if (!g.aborted && !A) {
                    if (E = i(v),
                    E || (r("cannot access response document"),
                    t = j),
                    t === C && g)
                    ...
                    if (E && E.location.href != f.iframeSrc || x) {
                        ...
                        try {
                            ...
                            if (c || f.textarea) {
                                ...
                                "xml" == u && !g.responseXML && g.responseText && (g.responseXML = $(g.responseText));
                            try {
                                Y = D(g, u, f)
                            } catch (b) {
                                o = "parsererror",
                        ...
                        o = null),
                        g.status && (o = g.status >= 200 && g.status < 300 || 304 === g.status ? "success" : "error"),
                        "success" === o ? (f.success && f.success.call(f.context, Y, "success", g),
                        k.resolve(g.responseText, "success", g),
                        p && e.event.trigger("ajaxSuccess", [g, f])) : o && (void 0 === n && (n = g.statusText),
                        f.error && f.error.call(f.context, g, o, n),
                        k.reject(g, "error", n),
                        p && e.event.trigger("ajaxError", [g, f, n])),
                        p && e.event.trigger("ajaxComplete", [g, f]),
                        p && !--e.active && e.event.trigger("ajaxStop"),
                        f.complete && f.complete.call(f.context, g, o),
                        A = !0,
            ...
            var u, c, f, p, h, y, v, g, b, w, x, T, P = d[0], k = e.Deferred();
            ...
            if (f = e.extend(!0, {}, e.ajaxSettings, t),
            f.context = f.context || f,
            h = "jqFormIO" + (new Date).getTime(),
            f.iframeTarget ? (y = e(f.iframeTarget),
            w = y.attr2("name"),
            w ? h = w : y.attr2("name", h)) : (y = e('<iframe name="' + h + '" src="' + f.iframeSrc + '" />'),
            y.css({
                position: "absolute",
                top: "-1000px",
                left: "-1000px"
            ...
            g = {
                ...
                abort: function(t) {
                    ...
                    g.error = n,
                    f.error && f.error.call(f.context, g, n, t),
                    p && e.event.trigger("ajaxError", [g, f, n]),
                    f.complete && f.complete.call(f.context, g, n)
                }
            },
            p = f.global,
            ...
            b = P.clk,
            b && (w = b.name,
            w && !b.disabled && (f.extraData = f.extraData || {},
            f.extraData[w] = b.value,
            "image" == b.type && (f.extraData[w + ".x"] = P.clk_x,
            f.extraData[w + ".y"] = P.clk_y)));
            var C = 1
              , j = 2
              , S = e("meta[name=csrf-token]").attr("content")
              , _ = e("meta[name=csrf-param]").attr("content");
            _ && S && (f.extraData = f.extraData || {},
            f.extraData[_] = S),
            f.forceSync ? a() : setTimeout(a, 10);
            var Y, E, A, Q = 50, $ = e.parseXML || function(e, t) {
            ...
            , D = function(t, n, r) {
                ...
                "string" == typeof a && ("json" === n || !n && i.indexOf("json") >= 0 ? a = I(a) : ("script" === n || !n && i.indexOf("javascript") >= 0) && e.globalEval(a)),
                a
            };
            return k
        }
        ...
        var f = {};
        if (this.trigger("form-pre-serialize", [this, t, f]),
        f.veto)
        ...
        var h, m = [], y = this.formToArray(t.semantic, m);
        ...
        t.beforeSubmit && t.beforeSubmit(y, this, t) === !1)
            ...
            this;
        if (this.trigger("form-submit-validate", [y, this, t, f]),
        f.veto)
        ...
        t.iframe !== !1 && (t.iframe || _) ? t.closeKeepAlive ? e.get(t.closeKeepAlive, function() {
            S = l(y)
        }) : S = l(y) : S = (P || C) && j ? a(y) : e.ajax(t),
        d.removeData("jqxhr").data("jqxhr", S);
    ...
    e.fn.ajaxForm = function(i) {
        ...
        !i.delegation && 0 === this.length) {
            ...
            return !e.isReady && o.s ? (r("DOM not ready, queuing ajaxForm"),
            e(function() {
        ...
        this) : this.ajaxFormUnbind().bind("submit.form-plugin", i, t).bind("click.form-plugin", i, n)
    }
    ,
    ...
    e.fn.formToArray = function(t, n) {
        ...
        if (0 === this.length)
            return r;
        var o, a = this[0], l = this.attr("id"), s = t ? a.getElementsByTagName("*") : a.elements;
        if (s && !/MSIE [678]/.test(navigator.userAgent) && (s = e(s).get()),
        l && (o = e(":input[form=" + l + "]").get(),
        ...
        h = s.length; u < h; u++)
            ...
            d && !p.disabled)
                ...
                f && f.constructor == Array)
                    ...
                    null !== f && "undefined" != typeof f && (n && n.push(p),
                    r.push({
                        name: d,
                        value: f,
                        type: p.type,
        ...
        if (!t && a.clk) {
            var v = e(a.clk)
              , g = v[0];
            d = g.name,
            d && !g.disabled && "image" == g.type && (r.push({
                name: d,
                value: v.val()
            }),
            r.push({
    ...
    e.fieldValue = function(t, n) {
        ...
        if ("select" == o) {
            ...
            for (var l = [], s = t.options, u = "select-one" == i, c = u ? a + 1 : s.length, d = u ? a : 0; d < c; d++) {
                ...
                if (f.selected) {
                    var p = f.value;
                    if (p || (p = f.attributes && f.attributes.value && !f.attributes.value.specified ? f.text : f.value),
                    u)
                        return p;
                    l.push(p)
                }
...
function(e, t, n, r) {
    ...
    function a(e, t) {
        var n = b["on" + e];
        n && (T(n) ? n.call(t[0]) : (n.addClass && t.addClass(n.addClass),
    ...
    function s(n) {
        if (j.length) {
            n = n || b.forceLoad,
            S = 1 / 0;
            var r, i, s = o(), u = t.innerHeight || v.clientHeight, c = t.innerWidth || v.clientWidth;
            for (r = 0,
            i = j.length; r < i; r++) {
                var d, f = j[r], h = f[0], y = f[p], g = !1, w = n;
                if (C(v, h)) {
    ...
    function u() {
        _ > 1 ? (_ = 1,
        s(),
        setTimeout(u, b.throttle)) : _ = 0
    }
    function c(e) {
        j.length && (e && "scroll" === e.type && e.currentTarget === t && S >= o() || (_ || setTimeout(u, 0),
        _ = 2))
    }
    function d() {
        x.lazyLoadXT()
    ...
    e.fn[p] = function(n) {
        n = n || {};
        var r, o = i(n, "blankImage"), l = i(n, "checkDuplicates"), s = i(n, "scrollContainer"), u = {};
        e(s).on("scroll", c);
        for (r in w)
            u[r] = i(n, r);
    ...
    e(n).ready(function() {
        a("start", x),
        x.on(b.loadEvent, d).on(b.updateEvent, c).on(b.forceEvent, f),
...
function(e) {
    ...
    e.fn.animateNumber = function() {
        for (var t = arguments[0], r = e.extend({}, n, t), i = e(this), o = [r], a = 1, l = arguments.length; a < l; a++)
            o.push(arguments[a]);
        if (t.numberStep) {
...
function() {
    ...
    function d(e, t, n) {
        ...
        for (var r = -1, i = n - t || 0, o = Array(i < 0 ? 0 : i); ++r < i; )
            o[r] = e[t + r];
        return o
    }
    function f(n) {
        function h(e) {
            return e && "object" == typeof e && !Gn(e) && In.call(e, "__wrapped__") ? e : new m(e)
        }
        function m(e, t) {
            this.__chain__ = !!t,
            this.__wrapped__ = e
        ...
        function W(e, t, n, r, i) {
            ...
            if (t) {
                ...
                o = f ? d(e) : or({}, e);
            return f && (In.call(e, "index") && (o.index = e.index),
            In.call(e, "input") && (o.input = e.input)),
            t ? (r.push(e),
            i.push(o),
            (f ? Je : sr)(e, function(e, a) {
                o[a] = W(e, t, n, r, i)
            }),
            p && (u(r),
            u(i)),
        ...
        function J(e, t, n) {
            ...
            if ("undefined" == typeof r && (Jn.funcNames && (r = !e.name),
            r = r || !Jn.funcDecomp,
            !r)) {
                var i = Qn.call(e);
        ...
        function K(e) {
            function t() {
                ...
                if ((o || c) && (h || (h = d(arguments)),
                o && Dn.apply(h, o),
                c && h.length < l))
                    return r |= 16,
                    K([n, f ? r : r & -4, h, null, a, l]);
                if (h || (h = arguments),
                u && (n = e[p]),
                this instanceof t) {
                    e = X(n.prototype);
        ...
        function te(e, t, n, r, i, o) {
            ...
            if (!p) {
                ...
                if (h || m)
                    return te(h ? e.__wrapped__ : e, m ? t.__wrapped__ : t, n, r, i, o);
                if (d != z)
                    return !1;
                var y = e.constructor
                  , v = t.constructor;
        ...
        function ie(n, r, i) {
            ...
            for (; ++a < d; ) {
                var y = n[a]
                  , v = i ? i(y, a, n) : y;
                (r ? !a || h[h.length - 1] !== v : s(h, v) < 0) && ((i || p) && h.push(v),
                f.push(y))
            }
            return p ? (u(h.array),
            c(h)) : i && u(h),
        ...
        function ce(e) {
            var t, n;
            return !!(e && Sn.call(e) == z && (t = e.constructor,
            !Ye(t) || t instanceof t)) && (lr(e, function(e, t) {
                n = t
            }),
        ...
        function je(e) {
            ...
            var n = Sn.call(e)
              , r = e.length;
            return n == D || n == R || n == I || n == z && "number" == typeof r && Ye(e.splice) ? !r : (sr(e, function() {
                return t = !1
            }),
            t)
        }
        ...
        function qe(e) {
            for (var t = arguments, n = -1, r = ee(t, !0, !1, 1), i = t[2] && t[2][t[1]] === e ? 1 : r.length, o = hn(i); ++n < i; )
                o[n] = e[r[n]];
            return o
        }
        function He(e, t, n) {
            var r = -1
              ...
              , o = e ? e.length : 0
              , a = !1;
            return n = (n < 0 ? Hn(0, o + n) : n) || 0,
            Gn(e) ? a = i(e, t, n) > -1 : "number" == typeof o ? a = (De(e) ? e.indexOf(t, n) : i(e, t, n)) > -1 : sr(e, function(e) {
                if (++r >= n)
                    return !(a = e === t)
            }),
            a
        ...
        function Je(e, t, n) {
            var r = -1
              , i = e ? e.length : 0;
            if (t = t && "undefined" == typeof n ? t : J(t, n, 3),
            "number" == typeof i)
                for (; ++r < i && t(e[r], r, e) !== !1; )
                    ;
            else
        ...
        function et(e, t, n) {
            ...
            null == t && Gn(e))
                ...
                t = null == t && De(e) ? r : h.createCallback(t, n, 3),
                Je(e, function(e, n, r) {
                    var a = t(e, n, r);
                    a > i && (i = a,
                    o = e)
        ...
        function ut(e, t, n) {
            ...
            for (o || (t = h.createCallback(t, n, 3)),
            Je(e, function(e, n, i) {
                var a = d[++r] = s();
        ...
        function jt(e, t, n, r) {
            var i = 0
              , o = e ? e.length : i;
            for (n = n ? h.createCallback(n, r, 1) : Kt,
            t = n(t); i < o; ) {
                var a = i + o >>> 1;
                n(e[a]) < t ? i = a + 1 : o = a
            }
        ...
        function Et() {
            for (var e = -1, t = arguments.length; ++e < t; ) {
                var n = arguments[e];
                if (Gn(n) || fe(n))
                    var r = r ? ie(G(r, n).concat(G(n, r))) : n
            }
            return r || []
        }
        function At() {
            for (var e = arguments.length > 1 ? arguments : arguments[0], t = -1, n = e ? et(pr(e, "length")) : 0, r = hn(n < 0 ? 0 : n); ++t < n; )
                r[t] = pr(e, t);
            return r
        }
        function Qt(e, t) {
        ...
        function Lt(e, t, n) {
            ...
            return function() {
                ...
                d === !1)
                    ...
                    v ? (i && (i = En(i)),
                    c = a,
                    o = e.apply(l, r)) : i || (i = On(y, p))
                }
                return v && s ? s = En(s) : s || t === d || (s = On(m, t)),
                n && (v = !0,
                o = e.apply(l, r)),
                !v || s || i || (r = l = null),
                o
        ...
        function Rt(e, t) {
            ...
            var n = function() {
                var r = n.cache
                  , i = t ? t.apply(this, arguments) : v + arguments[0];
                return In.call(r, i) ? r[i] : r[i] = e.apply(this, arguments)
            };
            return n.cache = {},
            n
        }
        ...
        function Ut(e, t, n) {
            ...
            if (!Ye(e))
                throw new Pn;
            return n === !1 ? r = !1 : Ee(n) && (r = "leading"in n ? n.leading : r,
        ...
        function Gt(e, t, n) {
            var r = !0
              , i = t && we(t);
            t && (n || i.length) || (null == n && (n = t),
            o = m,
            t = e,
            e = h,
            i = we(t)),
            n === !1 ? r = !1 : Ee(n) && "chain"in n && (r = n.chain);
            var o = e
              , a = Ye(o);
            Je(i, function(n) {
                var i = e[n] = t[n];
        ...
        function nn(e, t, n) {
            var r = null == e
              , i = null == t;
            if (null == n && ("boolean" == typeof e && i ? (n = e,
            e = 1) : i || "boolean" != typeof t || (n = t,
            i = !0)),
            r && i && (t = 1),
            e = +e || 0,
            i ? (t = e,
        ...
        function on(e, t, n) {
            ...
            e = Tn(e || ""),
            n = ar({}, n, r);
            var i, o = ar({}, n.imports, r.imports), l = er(o), s = Fe(o), u = 0, c = n.interpolate || Y, d = "__p += '", f = xn((n.escape || Y).source + "|" + c.source + "|" + (c === S ? k : Y).source + "|" + (n.evaluate || Y).source + "|$", "g");
            e.replace(f, function(t, n, r, o, l, s) {
                return r || (r = o),
                d += e.slice(u, s).replace(A, a),
                n && (d += "' +\n__e(" + n + ") +\n'"),
                l && (i = !0,
                d += "';\n" + l + ";\n__p += '"),
                r && (d += "' +\n((__t = (" + r + ")) == null ? '' : __t) +\n'"),
            ...
            y || (m = "obj",
            d = "with (" + m + ") {\n" + d + "\n}\n"),
            d = (i ? d.replace(x, "") : d).replace(T, "$1").replace(P, "$1;"),
        ...
        var hn = n.Array
          ...
          , jn = n._
          , Sn = Cn.toString
          , _n = xn("^" + Tn(Sn).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$")
          , Yn = gn.ceil
          , En = n.clearTimeout
          , An = gn.floor
        ...
        : Zn
          ...
          , or = function(e, t, n) {
            ...
            for (; ++l < s; )
                if (i = a[l],
                i && U[typeof i])
                    for (var c = -1, d = U[typeof i] && er(i), f = d ? d.length : 0; ++c < f; )
                        r = d[c],
                        o[r] = u ? u(o[r], i[r]) : i[r];
            return o
        }
          , ar = function(e, t, n) {
            ...
            for (var a = arguments, l = 0, s = "number" == typeof n ? 2 : a.length; ++l < s; )
                if (i = a[l],
                i && U[typeof i])
                    for (var u = -1, c = U[typeof i] && er(i), d = c ? c.length : 0; ++u < d; )
                        r = c[u],
          ...
          , ur = $n ? function(e) {
            ...
            var t = e.valueOf
              , n = ue(t) && (n = $n(t)) && $n(n);
            return n ? e == n || $n(e) == n : ce(e)
        }
        : ce
          , cr = oe(function(e, t, n) {
            In.call(e, n) ? e[n]++ : e[n] = 1
        })
          , dr = oe(function(e, t, n) {
            (In.call(e, n) ? e[n] : e[n] = []).push(t)
        })
          ...
          , yr = 8 == Wn(w + "08") ? Wn : function(e, t) {
            return Wn(De(e) ? e.replace(_, "") : e, t || 0)
        }
        ;
        return h.after = $t,
        h.assign = or,
    ...
    var p, h = [], m = [], y = 0, v = +new Date + "", g = 75, b = 40, w = " \t\x0B\fÂ \ufeff\n\r\u2028\u2029áš€á Žâ€€â€â€‚â€ƒâ€„â€…â€†â€‡â€ˆâ€‰â€Šâ€¯âŸã€€", x = /\b__p \+= '';/g, T = /\b(__p \+=) '' \+/g, P = /(__e\(.*?\)|\b__t\)) \+\n'';/g, k = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, C = /\w*$/, j = /^\s*function[ \n\r\t]+\w/, S = /<%=([\s\S]+?)%>/g, _ = RegExp("^[" + w + "]*0+(?=.$)"), Y = /($^)/, E = /\bthis\b/, A = /['\n\r\t\u2028\u2029\\]/g, Q = ["Array", "Boolean", "Date", "Function", "Math", "Number", "Object", "RegExp", "String", "_", "attachEvent", "clearTimeout", "isFinite", "isNaN", "parseInt", "setTimeout"], $ = 0, I = "[object Arguments]", D = "[object Array]", O = "[object Boolean]", N = "[object Date]", M = "[object Function]", L = "[object Number]", z = "[object Object]", B = "[object RegExp]", R = "[object String]", F = {};
    F[M] = !1,
    ...
    var Z = f();
    "function" == typeof define && "object" == typeof define.amd && define.amd ? (V._ = Z,
    define(function() {
        return Z
...
window.Modernizr = function(e, t, n) {
    ...
    function s(e, t, n) {
        ...
        return i(t, "string") || i(t, "undefined") ? a(o, t) : (o = (e + " " + w.join(r + " ") + r).split(" "),
        l(o, t, n))
    }
    var u, c, d, f = "2.8.3", p = {}, h = t.documentElement, m = "modernizr", y = t.createElement(m), v = y.style, g = ({}.toString,
    "Webkit Moz O ms"), b = g.split(" "), w = g.toLowerCase().split(" "), x = {}, T = [], P = T.slice, k = {}.hasOwnProperty;
    ...
    return p.addTest = function(e, t) {
        if ("object" == typeof e)
            ...
            "undefined" != typeof enableClasses && enableClasses && (h.className += " " + (t ? "" : "no-") + e),
            p[e] = t
        }
        return p
    }
...
function() {
    ...
    t = function() {
        ...
        e.prototype.createEvent = function(e, t, n, r) {
            ...
            null == n && (n = !1),
            null == r && (r = null),
            null != document.createEvent ? (i = document.createEvent("CustomEvent"),
            i.initCustomEvent(e, t, n, r)) : null != document.createEventObject ? (i = document.createEventObject(),
            i.eventType = e) : i.eventName = e,
            i
        }
        ,
        ...
        i.prototype.vendorSet = function(e, t) {
            ...
            for (n in t)
                ...
                r.push(function() {
                    ...
                    r = a.length; t < r; t++)
                        o = a[t],
                        l.push(e["" + o + n.charAt(0).toUpperCase() + n.substr(1)] = i);
                    return l
                }
                .call(this));
            return r
...
$(function() {
    ...
    function n(t, n) {
        plp.isRetina() && n.retina && (n.width2 *= 2,
        n.height2 *= 2);
        var r = Math.min(n.width1, 2e3)
          , i = Math.min(n.height1, 2e3);
        n.width2 > r && (n.height2 = r / n.width2 * n.height2,
        n.width2 = r),
        n.height2 > i && (n.width2 = i / n.height2 * n.width2,
        n.height2 = i);
        var o = e({
            h: n.height2,
            w: n.width2
    ...
    plp.lazy.add($("[data-lazy-image]"), function(e) {
        ...
        if (t(r) && "true" !== e.attr("data-lazy-image_noscale")) {
            ...
            if ("css-width" === a)
                ...
                o.height1 > s ? (o.height2 = s,
                o.width2 = s / o.height1 * o.width1) : e.css("max-height", o.height2)
            } else if ("css-max-width-max-height" === a) {
                var u = parseInt(e.css("max-width"))
                  , c = parseInt(e.css("max-height"));
                o.width2 > u && (o.width2 = u,
                o.height2 = u / o.width1 * o.height1),
                o.height2 > c && (o.width2 = c / o.height2 * o.width2,
                o.height2 = c),
                ...
                "fill-width" === a && (o.width2 = e.parent().width(),
        ...
        e.addClass("lazy-loading"),
        $("<img>").attr("src", r).on("load", function() {
            e.attr("src", r),
            e.removeClass("lazy-loading"),
            e.trigger("lazyload")
        }).on("error", function() {
    ...
    plp.lazy.add($("[data-lazy-bgimage]"), function(e) {
        ...
        if (t(r) && "true" !== e.attr("data-lazy-bgimage_noscale")) {
            ...
            "cover" === s ? (o.width1 > a && (o.width2 = a,
            o.height2 = a / o.width1 * o.height1),
            o.height2 < l && (o.height2 = l,
            o.width2 = l / o.height1 * o.width1)) : "contain" === s && (o.width2 > a && (o.width2 = a,
            o.height2 = a / o.width1 * o.height1),
            o.height2 > l && (o.height2 = l,
            o.width2 = l / o.height1 * o.width1));
            var r = n(r, o)
        }
        e.data(),
...
$(function() {
    ...
    var e = function(e) {
      ...
      , i = r.find(".cont").first()
      , o = i.next();
    i.find('[data-role="itemphoto"]').attr("data-lazy-bgimage", n),
    ...
    plp.cart.add = function(e) {
        ...
        if (_.each(plp.cart.list, function(e, n) {
            ...
            t.value === o.value && r.value === a.value && (u.value += 1 * i.value,
        ...
        l.append(c),
        c.find('[data-role="setamount"]').val(i.value),
        c.find('[data-role="itemprice"]').html(r.value),
        c.find('[data-role="itemname"]').html(t.value),
        c.find('[data-role="itemphoto"]').css("backgroundImage", 'url("' + (o.value || n) + '")'),
        u = u.add(c),
        c.on("setamount", function(e, t) {
            i.value = t,
            store.set("cart", plp.cart.list),
            c.find('[data-role="setamount"]').val(t),
            i.value ? plp.cart.update() : c.trigger("removefromcart")
        }),
    ...
    plp.cart.update = function() {
        ...
        plp.cart.list.length ? (i.show(),
        o.hide(),
        void $('[data-role="carttotal"] span').html(n.replace("%s%", a))) : ($('[data-role="carttotal"] span').html("-"),
        o.show(),
        void i.hide())
    }
    ,
    ...
    $(document.body).on("click", '[data-action="addtocart"]', function(e) {
        ...
        if (!t.length)
            return void swal("Ð¢Ð¾Ð²Ð°Ñ€ Ð½Ðµ Ð½Ð°Ð¹Ð´ÐµÐ½", "ÐšÐ½Ð¾Ð¿ÐºÐ° Ð´Ð¾Ð»Ð¶Ð½Ð° Ð½Ð°Ñ…Ð¾Ð´Ð¸Ñ‚ÑŒÑÑ Ð² ÐºÐ°Ñ€Ñ‚Ð¾Ñ‡ÐºÐµ Ñ‚Ð¾Ð²Ð°Ñ€Ð°.", "error");
        var n = _.cloneDeep(t.data("item"))
          , r = t.find('[data-role="setamount"]');
        if (r.length)
            var i = {
                name: "ÐšÐ¾Ð»Ð¸Ñ‡ÐµÑÑ‚Ð²Ð¾",
                type: "amount",
                value: 1 * r.val() || 1
            };
        else
        ...
        swal({
            ...
            type: "success",
            showCancelButton: !0,
            cancelButtonText: "ÐžÐš",
            confirmButtonText: "ÐžÑ‚ÐºÑ€Ñ‹Ñ‚ÑŒ ÐºÐ¾Ñ€Ð·Ð¸Ð½Ñƒ"
        }, function() {
...
function(e, t) {
    ...
    var t, n = {}, r = "undefined" != typeof window ? window : global, i = r.document, o = "localStorage", a = "script";
    if (n.disabled = !1,
    n.version = "1.3.20",
    n.set = function(e, t) {}
    ,
    ...
    e())
        ...
        try {
            ...
            s.open(),
            s.write("<" + a + ">document.w=window</" + a + '><iframe src="/favicon.ico"></iframe>'),
            s.close(),
...
function(e, t, n) {
    ...
    function o(t, n) {
        ...
        this.value = function(t) {
            var r;
            return void 0 === this.cache[t] && (r = e(this.el).attr("data-cbox-" + t),
            void 0 !== r ? this.cache[t] = r : void 0 !== n[t] ? this.cache[t] = n[t] : void 0 !== K[t] && (this.cache[t] = K[t])),
            this.cache[t]
        }
        ,
        this.get = function(t) {
    ...
    function c(e) {
        "contains"in b[0] && !b[0].contains(e.target) && e.target !== g[0] && (e.stopPropagation(),
        b.focus())
    }
    function d(e) {
        d.str !== e && (b.add(g).removeClass(d.str).addClass(e),
        d.str = e)
    }
    function f(t) {
        F = 0,
        t && t !== !1 && "nofollow" !== t ? (j = e("." + ee).filter(function() {
            var n = e.data(this, G)
              , r = new o(this,n);
            return r.get("rel") === t
        }),
    ...
    function h(n) {
        ...
        if (!W) {
            ...
            !H) {
                ...
                _ = r(se, "LoadedContent", "width:0; height:0; overflow:hidden; visibility:hidden"),
                x.css({
                    width: "",
                    height: ""
                }).append(_),
                ...
                var a = l(M.get("initialWidth"), "x")
                  ...
                  , u = M.get("maxWidth")
                  , h = M.get("maxHeight");
                M.w = (u !== !1 ? Math.min(a, l(u, "x")) : a) - R - z,
                M.h = (h !== !1 ? Math.min(s, l(h, "y")) : s) - B - L,
                _.css({
                    width: "",
                    height: M.h
                }),
                ...
                N.add(A).hide(),
                b.focus(),
                M.get("trapFocus") && t.addEventListener && (t.addEventListener("focus", c, !0),
                le.one(oe, function() {
            ...
            M.get("closeButton") ? O.html(M.get("close")).appendTo(x) : O.appendTo("<div/>"),
            v()
        }
    }
    function m() {
        ...
        g = r(se, "Overlay").hide(),
        E = e([r(se, "LoadingOverlay")[0], r(se, "LoadingGraphic")[0]]),
        w = r(se, "Wrapper"),
        ...
        w.append(r(se).append(r(se, "TopLeft"), T = r(se, "TopCenter"), r(se, "TopRight")), r(se, !1, "clear:left").append(P = r(se, "MiddleLeft"), x, k = r(se, "MiddleRight")), r(se, !1, "clear:left").append(r(se, "BottomLeft"), C = r(se, "BottomCenter"), r(se, "BottomRight"))).find("div div").css({
            "float": "left"
        }),
        Y = r(se, !1, "position:absolute; width:9999px; visibility:hidden; display:none; max-width:none;"),
        N = I.add(D).add(Q).add($),
    ...
    function y() {
        ...
        e(t).bind("keydown." + Z, function(e) {
            var t = e.keyCode;
            H && M.get("escKey") && 27 === t && (e.preventDefault(),
            X.close()),
            H && M.get("arrowKey") && j[1] && !e.altKey && (37 === t ? (e.preventDefault(),
            D.click()) : 39 === t && (e.preventDefault(),
            I.click()))
        }),
    ...
    function v() {
        var t, i, o, a = X.prep, c = ++ue;
        if (U = !0,
        q = !1,
        p(ae),
        p(ne),
        M.get("onLoad"),
        M.h = M.get("height") ? l(M.get("height"), "y") - B - L : M.get("innerHeight") && l(M.get("innerHeight"), "y"),
        M.w = M.get("width") ? l(M.get("width"), "x") - R - z : M.get("innerWidth") && l(M.get("innerWidth"), "x"),
        M.mw = M.w,
        M.mh = M.h,
        M.get("maxWidth") && (M.mw = l(M.get("maxWidth"), "x") - R - z,
        M.mw = M.w && M.w < M.mw ? M.w : M.mw),
        M.get("maxHeight") && (M.mh = l(M.get("maxHeight"), "y") - B - L,
        ...
        M.get("inline")) {
            var d = e(t);
            o = e("<div>").hide().insertBefore(d),
            le.one(ae, function() {
                o.replaceWith(d)
            }),
            a(d)
        } else
            M.get("iframe") ? a(" ") : M.get("html") ? a(M.get("html")) : s(M, t) ? (t = u(M, t),
            q = new Image,
            e(q).addClass(Z + "Photo").bind("error", function() {
                ...
                c === ue && setTimeout(function() {
                    ...
                    M.get("retinaImage") && n.devicePixelRatio > 1 && (q.height = q.height / n.devicePixelRatio,
                    q.width = q.width / n.devicePixelRatio),
                    M.get("scalePhotos") && (i = function() {
                        q.height -= q.height * t,
                        q.width -= q.width * t
                    }
                    ,
                    M.mw && q.width > M.mw && (t = (q.width - M.mw) / q.width,
                    i()),
                    M.mh && q.height > M.mh && (t = (q.height - M.mh) / q.height,
                    i())),
                    M.h && (q.style.marginTop = Math.max(M.mh - q.height, 0) / 2 + "px"),
                    j[1] && (M.get("loop") || j[F + 1]) && (q.style.cursor = "pointer",
                    q.onclick = function() {
                        X.next()
                    }
                    ),
            ...
            q.src = t) : t && Y.load(t, M.get("data"), function(t, n) {
                c === ue && a("error" === n ? r(se, "Error").html(M.get("xhrError")) : e(this).contents())
            })
    }
    var g, b, w, x, T, P, k, C, j, S, _, Y, E, A, Q, $, I, D, O, N, M, L, z, B, R, F, q, H, U, W, V, X, J, K = {
        html: !1,
        photo: !1,
        iframe: !1,
        inline: !1,
    ...
    }, G = "colorbox", Z = "cbox", ee = Z + "Element", te = Z + "_open", ne = Z + "_load", re = Z + "_complete", ie = Z + "_cleanup", oe = Z + "_closed", ae = Z + "_purge", le = e("<a/>"), se = "div", ue = 0, ce = {}, de = function() {
        function e() {
            clearTimeout(a)
        }
        function t() {
        ...
        function n() {
            $.html(M.get("slideshowStop")).unbind(s).one(s, r),
            le.bind(re, t).bind(ne, e),
            b.removeClass(l + "off").addClass(l + "on")
        }
        function r() {
            e(),
            le.unbind(re, t).unbind(ne, e),
            $.html(M.get("slideshowStart")).unbind(s).one(s, function() {
                X.next(),
                n()
            }),
        ...
        var o, a, l = Z + "Slideshow_", s = "click." + Z;
        return function() {
            o ? M.get("slideshow") || (le.unbind(ie, i),
            i()) : M.get("slideshow") && j[1] && (o = !0,
            le.one(ie, i),
            M.get("slideshowAuto") ? n() : r(),
            $.show())
        }
    }();
    e.colorbox || (e(m),
    ...
    X.position = function(t, n) {
        function r() {
            T[0].style.width = C[0].style.width = x[0].style.width = parseInt(b[0].style.width, 10) - z + "px",
            x[0].style.height = P[0].style.height = k[0].style.height = parseInt(b[0].style.height, 10) - L + "px"
        }
        var o, a, s, u = 0, c = 0, d = b.offset();
        ...
        c += M.get("right") !== !1 ? Math.max(S.width() - M.w - R - z - l(M.get("right"), "x"), 0) : M.get("left") !== !1 ? l(M.get("left"), "x") : Math.round(Math.max(S.width() - M.w - R - z, 0) / 2),
        u += M.get("bottom") !== !1 ? Math.max(i() - M.h - B - L - l(M.get("bottom"), "y"), 0) : M.get("top") !== !1 ? l(M.get("top"), "y") : Math.round(Math.max(i() - M.h - B - L, 0) / 2),
        b.css({
            top: d.top,
            left: d.left,
            visibility: "visible"
    ...
    X.resize = function(e) {
        ...
        e.innerHeight || e.height || (t = _.scrollTop(),
        _.css({
            height: "auto"
        }),
        M.h = _.height()),
    ...
    X.prep = function(n) {
        ...
        if (H) {
            ...
            c = function() {
                ...
                _.show(),
                l > 1 ? ("string" == typeof M.get("current") && Q.html(M.get("current").replace("{current}", F + 1).replace("{total}", l)).show(),
                I[M.get("loop") || F < l - 1 ? "show" : "hide"]().html(M.get("next")),
                D[M.get("loop") || F ? "show" : "hide"]().html(M.get("previous")),
                de(),
                M.get("preloading") && e.each([a(-1), a(1)], function() {
                    var n, r = j[this], i = new o(r,e.data(r, G)), a = i.get("href");
                    a && s(i, a) && (a = u(i, a),
                    n = t.createElement("img"),
                    n.src = a)
                })) : N.hide(),
                M.get("iframe") ? (r = t.createElement("iframe"),
                ...
                M.get("fastIframe") && e(r).trigger("load")) : i(),
                "fade" === M.get("transition") ? b.fadeTo(f, 1, n) : n())
            }
            ,
    ...
    ,
    X.next = function() {
        !U && j[1] && (M.get("loop") || j[F + 1]) && (F = a(1),
        h(j[F]))
    }
    ,
    X.prev = function() {
        !U && j[1] && (M.get("loop") || F) && (F = a(-1),
        h(j[F]))
    }
    ,
    X.close = function() {
    ...
    X.remove = function() {
        ...
        W = !1,
        b = null,
        e("." + ee).removeData(G).removeClass(ee),
...
function(e, t) {
    function n() {
        function n(t) {
            ...
            if ([9, 13, 32, 27].indexOf(r) !== -1) {
                ...
                9 === r ? (i = o === -1 ? T : o === k.length - 1 ? k[0] : k[o + 1],
                I(n),
                i.focus(),
                l(i, d.confirmButtonColor)) : (i = 13 === r || 32 === r ? o === -1 ? T : void 0 : 27 !== r || P.hidden || "none" === P.style.display ? void 0 : P,
                void 0 !== i && $(i, n))
            }
        }
        function a(t) {
        ...
        case "object":
            ...
            d.showCancelButton = void 0 !== arguments[0].showCancelButton ? arguments[0].showCancelButton : g.showCancelButton,
            d.closeOnConfirm = void 0 !== arguments[0].closeOnConfirm ? arguments[0].closeOnConfirm : g.closeOnConfirm,
            d.closeOnCancel = void 0 !== arguments[0].closeOnCancel ? arguments[0].closeOnCancel : g.closeOnCancel,
            d.timer = arguments[0].timer || g.timer,
            d.confirmButtonText = g.showCancelButton ? "Confirm" : g.confirmButtonText,
        ...
        }, v = m.querySelectorAll("button"), w = 0; w < v.length; w++)
            v[w].onclick = y,
            v[w].onmouseover = y,
            v[w].onmouseout = y,
            v[w].onmousedown = y,
    ...
    function r(t) {
        ...
        if (r.innerHTML = k(t.title).split("\n").join("<br>"),
        ...
        t.showCancelButton ? o.style.display = "inline-block" : _(o),
    ...
    var d, f, p, h, m = ".sweet-alert", y = ".sweet-overlay", v = ["error", "warning", "info", "success"], g = {
        title: "",
        text: "",
        type: null,
        allowOutsideClick: !1,
...
!function(jQuery, ytp) {
    ...
    jQuery.fn.CSSAnimate = function(e, t, n, r, i) {
        ...
        this.each(function() {
            ...
            if (l.CSSAIsRunning && l.eventType == u.type)
                ...
                ;
            else if (l.CSSqueue = null,
            l.eventType = u.type,
            0 !== s.length && e) {
                if (l.CSSAIsRunning = !0,
                ...
                jQuery.support.CSStransition) {
                    ...
                    f = "webkitTransitionEnd") : jQuery.browser.mozilla ? (d = "-moz-",
                    f = "transitionend") : jQuery.browser.opera ? (d = "-o-",
                    f = "otransitionend") : jQuery.browser.msie && (d = "-ms-",
                    f = "msTransitionEnd"),
                    u = [];
                    for (p in e)
                        c = p,
                        "transform" === c && (c = d + "transform",
                        e[c] = e[p],
                        delete e[p]),
                        "filter" === c && (c = d + "filter",
                        e[c] = e[p],
                        delete e[p]),
                        "transform-origin" !== c && "origin" !== c || (c = d + "transform-origin",
                        e[c] = e[p],
                        delete e[p]),
                        "x" === c && (c = d + "transform",
                        e[c] = e[c] || "",
                        ...
                        delete e[p]),
                        "rotate" === c && (c = d + "transform",
                        e[c] = e[c] || "",
                        e[c] += " rotate(" + a(e[p], "deg") + ")",
                        delete e[p]),
                        "rotateX" === c && (c = d + "transform",
                        e[c] = e[c] || "",
                        e[c] += " rotateX(" + a(e[p], "deg") + ")",
                        delete e[p]),
                        "rotateY" === c && (c = d + "transform",
                        e[c] = e[c] || "",
                        e[c] += " rotateY(" + a(e[p], "deg") + ")",
                        delete e[p]),
                        "rotateZ" === c && (c = d + "transform",
                        e[c] = e[c] || "",
                        e[c] += " rotateZ(" + a(e[p], "deg") + ")",
                        delete e[p]),
                        "scale" === c && (c = d + "transform",
                        e[c] = e[c] || "",
                        e[c] += " scale(" + a(e[p], "") + ")",
                        delete e[p]),
                        "scaleX" === c && (c = d + "transform",
                        e[c] = e[c] || "",
                        e[c] += " scaleX(" + a(e[p], "") + ")",
                        delete e[p]),
                        "scaleY" === c && (c = d + "transform",
                        e[c] = e[c] || "",
                        e[c] += " scaleY(" + a(e[p], "") + ")",
                        delete e[p]),
                        "scaleZ" === c && (c = d + "transform",
                        e[c] = e[c] || "",
                        e[c] += " scaleZ(" + a(e[p], "") + ")",
                        delete e[p]),
                        "skew" === c && (c = d + "transform",
                        e[c] = e[c] || "",
                        e[c] += " skew(" + a(e[p], "deg") + ")",
                        delete e[p]),
                        "skewX" === c && (c = d + "transform",
                        e[c] = e[c] || "",
                        e[c] += " skewX(" + a(e[p], "deg") + ")",
                        delete e[p]),
                        "skewY" === c && (c = d + "transform",
                        e[c] = e[c] || "",
                        e[c] += " skewY(" + a(e[p], "deg") + ")",
                        delete e[p]),
                        "perspective" === c && (c = d + "transform",
                        e[c] = e[c] || "",
                    ...
                    var p = u.join(",")
                      , h = function() {
                        ...
                        l.called = !0,
                        l.CSSAIsRunning = !1,
                        "function" == typeof l.CSSqueue && (l.CSSqueue(),
                        l.CSSqueue = null)
                    }
                      , m = {};
                    jQuery.extend(m, e),
                    ...
                    l.timeout = setTimeout(function() {
                        s.called || !i ? (s.called = !1,
                        l.CSSAIsRunning = !1) : (s.css(d + "transition", ""),
                        i(s),
                        l.CSSAIsRunning = !1,
                        "function" == typeof l.CSSqueue && (l.CSSqueue(),
                        l.CSSqueue = null))
        ...
        e.simpleSlider = {
            ...
            init: function(t) {
                return this.each(function() {
                    ...
                    r.updateSliderVal(),
                    n.opt.readonly || (r.on("mousedown", function(e) {
                        n.canSlide = !0,
                        r.updateSliderVal(e)
                    }),
            ...
            updateSliderVal: function(t) {
                ...
                var o = e(i).outerWidth()
                  , a = e(i).outerHeight();
                i.x = "object" == typeof t ? t.clientX + document.body.scrollLeft - r.offset().left : "number" == typeof t ? t * o / i.opt.scale : i.opt.initialval * o / i.opt.scale,
                i.y = "object" == typeof t ? t.clientY + document.body.scrollTop - r.offset().top : "number" == typeof t ? (i.opt.scale - i.opt.initialval - t) * a / i.opt.scale : i.opt.initialval * a / i.opt.scale,
                ...
                i.value = "undefined" != typeof t ? "h" == i.opt.orientation ? i.x >= r.outerWidth() ? i.opt.scale : i.x <= 0 ? 0 : i.scaleX : i.y >= r.outerHeight() ? i.opt.scale : i.y <= 0 ? 0 : i.scaleY : "h" == i.opt.orientation ? i.scaleX : i.scaleY,
                "h" == i.opt.orientation ? i.level.width(n(i.x, o) + "%") : i.level.height(n(i.y, a)),
    ...
    var getYTPVideoID = function(e) {
        ...
        t = n ? t.substr(0, t.lastIndexOf("?")) : t) : e.indexOf("http") > -1 ? (t = e.match(/[\\?&]v=([^&#]*)/)[1],
        n = e.indexOf("list=") > 0 ? e.match(/[\\?&]list=([^&#]*)/)[1] : null) : (t = e.length > 15 ? null : e,
        n = t ? null : e),
        {
            videoID: t,
            playlistID: n
    ...
    jQuery.mbYTPlayer = {
                                            ...
                                            if ("function" == typeof event.target.getPlayerState) {
                                                ...
                                                if (YTPlayer.state != state) {
                                                    ...
                                                    case 1:
                                                        ...
                                                        "undefined" != typeof _gaq && eval(YTPlayer.opt.gaTrack) && _gaq.push(["_trackEvent", "YTPlayer", "Play", YTPlayer.videoData.title || YTPlayer.videoID.toString()]),
                                                        "undefined" != typeof ga && eval(YTPlayer.opt.gaTrack) && ga("send", "event", "YTPlayer", "play", YTPlayer.videoData.title || YTPlayer.videoID.toString());
                                                        break;
                                                    case 2:
                                                        eventType = "YTPPause",
        ...
        getDataFromAPI: function(e) {
            if (e.videoData = jQuery.mbStorage.get("YYTPlayer_data_" + e.videoID),
            e.videoData)
                setTimeout(function() {
                    "auto" == e.opt.ratio ? e.opt.ratio = "16/9" : e.opt.ratio,
                    e.dataReceived = !0,
                ...
                jQuery.getJSON("https://www.googleapis.com/youtube/v3/videos?id=" + e.videoID + "&key=" + e.opt.apiKey + "&part=snippet", function(t) {
                    function n(t) {
                        e.videoData = {},
                        ...
                        e.videoData.aspectratio = "auto" == e.opt.ratio ? "16/9" : "4/3",
                        ...
                        jQuery.mbStorage.set("YYTPlayer_data_" + e.videoID, e.videoData)
                    }
                    e.dataReceived = !0,
                    jQuery(e).trigger("YTPChanged"),
                    n(t.items[0].snippet);
        ...
        changeMovie: function(e) {
            ...
            jQuery(t.playerEl).CSSAnimate({
                ...
                jQuery(t).YTPGetPlayer().cueVideoByUrl(encodeURI(jQuery.mbYTPlayer.locationProtocol + "//www.youtube.com/v/" + t.videoID), 1, t.opt.quality),
        ...
        fullscreen: function(real) {
            ...
            YTPlayer.isAlone ? (jQuery(document).off("mousemove.YTPlayer"),
            YTPlayer.overlay.css({
                cursor: "auto"
            }),
        ...
        setVolume: function(e) {
            var t = this.get(0);
            e || t.opt.vol || 0 != t.player.getVolume() ? !e && t.player.getVolume() > 0 || e && t.opt.vol == e ? t.isMute ? jQuery(t).YTPUnmute() : jQuery(t).YTPMute() : (t.opt.vol = e,
        ...
        mute: function() {
            ...
            if (!e.isMute) {
                ...
                e.volumeBar && e.volumeBar.length && e.volumeBar.updateSliderVal(0);
                var t = jQuery("#controlBar_" + e.id)
        ...
        toggleFilter: function(e, t) {
            var n = this.get(0);
            return n.filters[e].value ? n.filters[e].value = 0 : n.filters[e].value = t,
            n.filtersEnabled && this.YTPEnableFilters(),
            this
        },
        ...
        toggleFilters: function(e) {
            var t = this.get(0);
            return t.filtersEnabled ? (jQuery(t).trigger("YTPDisableFilters"),
        ...
        checkForState: function(YTPlayer) {
            ...
            void (YTPlayer.getState = setInterval(function() {
                ...
                eval(YTPlayer.opt.stopMovieOnBlur) && (document.hasFocus() ? document.hasFocus() && !YTPlayer.hasFocus && YTPlayer.state != -1 && 0 != YTPlayer.state && (YTPlayer.hasFocus = !0,
                ...
                1 == YTPlayer.player.getPlayerState() && (parseFloat(YTPlayer.player.getDuration() - 3) < YTPlayer.player.getCurrentTime() || stopAt > 0 && parseFloat(YTPlayer.player.getCurrentTime()) > stopAt)) {
                    ...
                    YTPlayer.wrapper.CSSAnimate({
                        ...
                        if (e.time = YTPlayer.player.time,
        ...
        checkForStart: function(e) {
            ...
            if (jQuery.browser.chrome && (e.opt.quality = "default"),
            e.player.pauseVideo(),
            ...
            e.checkForStartAt = setInterval(function() {
                ...
                if (e.player.getDuration() > 0 && e.player.getCurrentTime() >= n && r) {
                    ...
                    e.wrapper.CSSAnimate({
                        opacity: e.isAlone ? 1 : e.opt.opacity
                    }, 1e3)) : e.player.pauseVideo(),
                    e.isPlayer && !e.opt.autoPlay && (e.loading.html("Ready"),
                    setTimeout(function() {
                        e.loading.fadeOut()
                    }, 100)),
                    e.controlBar && e.controlBar.slideDown(1e3)
                } else
                    n >= 0 && e.player.seekTo(n, !0)
            }, 1e3)
        },
    ...
    jQuery.fn.optimizeDisplay = function() {
        ...
        var o = 24
          , a = 100
          , l = {};
        t.optimizeDisplay ? (l.width = r.width + r.width * o / 100,
        l.height = "16/9" == t.ratio ? Math.ceil(9 * r.width / 16) : Math.ceil(3 * r.width / 4),
        l.marginTop = -((l.height - r.height) / 2),
        l.marginLeft = -(r.width * (o / 2) / 100),
        l.height < r.height && (l.height = r.height + r.height * o / 100,
        l.width = "16/9" == t.ratio ? Math.floor(16 * r.height / 9) : Math.floor(4 * r.height / 3),
        l.marginTop = -(r.height * (o / 2) / 100),
        l.marginLeft = -((l.width - r.width) / 2)),
        l.width += a,
        l.height += a,
        l.marginTop -= a / 2,
        l.marginLeft -= a / 2) : (l.width = "100%",
        l.height = "100%",
        l.marginTop = 0,
        l.marginLeft -= 0),
        n.css({
...
!function(e, t) {
    ...
    function t(e) {
        var t, n, r, i, o, a, l, s = {};
        for (o = e.replace(/\s*:\s*/g, ":").replace(/\s*,\s*/g, ",").split(","),
        l = 0,
        a = o.length; l < a && (n = o[l],
        n.search(/^(http|https|ftp):\/\//) === -1 && n.search(":") !== -1); l++)
            t = n.indexOf(":"),
            r = n.substring(0, t),
            i = n.substring(t + 1),
            i || (i = void 0),
    ...
    function n(e) {
        e = "" + e;
        var t, n, r, i = e.split(/\s+/), o = "50%", a = "50%";
        for (r = 0,
        t = i.length; r < t; r++)
            n = i[r],
            "left" === n ? o = "0%" : "right" === n ? o = "100%" : "top" === n ? a = "0%" : "bottom" === n ? a = "100%" : "center" === n ? 0 === r ? o = "50%" : a = "50%" : 0 === r ? o = n : a = n;
        return {
            x: o,
            y: a
        }
    ...
    i.prototype.init = function() {
        var t, i = this, o = n(i.settings.position), a = "";
        i.$wrapper = e("<div>").css({
            position: "absolute",
            "z-index": -1,
            top: 0,
        ...
        t = i.path,
        "object" == typeof i.path && (i.path.poster ? t = i.path.poster : i.path.mp4 ? t = i.path.mp4 : i.path.webm ? t = i.path.webm : i.path.ogv && (t = i.path.ogv)),
        "detect" === i.settings.posterType ? r(t, function(e) {
            i.$wrapper.css("background-image", "url(" + e + ")")
        }) : "none" !== i.settings.posterType && i.$wrapper.css("background-image", "url(" + t + "." + i.settings.posterType + ")"),
        "static" === i.$element.css("position") && i.$element.css("position", "relative"),
        i.$element.prepend(i.$wrapper),
        "object" == typeof i.path ? (i.path.mp4 && (a += '<source src="' + i.path.mp4 + '.mp4" type="video/mp4">'),
        i.path.webm && (a += '<source src="' + i.path.webm + '.webm" type="video/webm">'),
        i.path.ogv && (a += '<source src="' + i.path.ogv + '.ogv" type="video/ogv">'),
        i.$video = e("<video>" + a + "</video>")) : i.$video = e('<video><source src="' + i.path + '.mp4" type="video/mp4"><source src="' + i.path + '.webm" type="video/webm"><source src="' + i.path + '.ogv" type="video/ogg"></video>'),
        i.$video.prop({
            ...
            i.$video.css("visibility", "visible"),
            i.$wrapper.css("background-image", "none")
        }),
...
function(e, t, n) {
    ...
    function l(n) {
        function r() {
            var e = h.cloneNode();
            return "solid" != g.type && (e[d ? "src" : "innerHTML"] = "string" == typeof g.content ? g.content : g.content[0 == p ? 0 : Math.floor(Math.random() * p)]),
            e
        }
        function l() {
            var e, t = i(g.minSize, g.maxSize), n = -2 * t, o = i(0, w - t), l = i(5, 10) / 10, s = i(null, .8 * x, 1), u = i(-100, 100), c = x + 2 * t, d = i(null, 20 * x, .2);
            v.length ? (e = v.shift(),
            e.dataset.type != g.type && (e = new r)) : e = new r;
            var f = {
                top: n + "px",
                left: o + "px",
                opacity: l,
        ...
        var d, p, h, m, y = this, v = [], g = c, b = t.createElement("div");
        y.config = function(e) {
            o(g, e),
            d = "image" == g.type,
            p = g.content.length,
            h = d ? new Image : t.createElement("div"),
        ...
        y.playing = 0,
        y.play = function() {
            y.playing || (m = setInterval(l, g.interval),
            y.playing = 1)
        }
        ,
        y.stop = function() {
            y.playing && (clearInterval(m),
            m = null,
            y.playing = 0)
        }
        ,
        ...
        g.root.firstChild ? g.root.insertBefore(b, g.root.firstChild) : g.root.appendChild(b),
        g.autoplay && y.play(),
        y
    }
    var s, u, c = {
    ...
    "undefined" != typeof t.hidden ? (s = "hidden",
    u = "visibilitychange") : "undefined" != typeof t.mozHidden ? (s = "mozHidden",
    u = "mozvisibilitychange") : "undefined" != typeof t.msHidden ? (s = "msHidden",
    u = "msvisibilitychange") : "undefined" != typeof t.webkitHidden && (s = "webkitHidden",
    ...
    e.fn.pagepiling = function(i) {
        ...
        function l(t, n) {
            ...
            if (!r.activeSection.is(t)) {
                ...
                r.destination.addClass("active").siblings().removeClass("active"),
                r.sectionsToMove = c(r),
                "down" === r.yMovement ? (r.translate3d = M(),
                r.scrolling = "-100%",
                X.css3 || r.sectionsToMove.each(function(t) {
                    t != r.activeSection.index(".pp-section") && e(this).css(f(r.scrolling))
                }),
                r.animateSection = r.activeSection) : (r.translate3d = "translate3d(0px, 0px, 0px)",
                r.scrolling = "0",
                r.animateSection = t),
                e.isFunction(X.onLeave) && X.onLeave.call(this, r.leavingSection, r.sectionIndex + 1, r.yMovement),
                s(r),
                O(r.anchorLink),
        ...
        function s(t) {
            X.css3 ? (b(t.animateSection, t.translate3d, t.animated),
            t.sectionsToMove.each(function() {
                b(e(this), t.translate3d, t.animated)
            }),
            setTimeout(function() {
                u(t)
            }, X.scrollingSpeed)) : (t.scrollOptions = f(t.scrolling),
            t.animated ? t.animateSection.animate(t.scrollOptions, X.scrollingSpeed, X.easing, function() {
                d(t),
                u(t)
            }) : (t.animateSection.css(f(t.scrolling)),
            setTimeout(function() {
                d(t),
                u(t)
            }, 400)))
        ...
        function p(e, t) {
            X.anchors.length ? (location.hash = e,
            h(location.hash)) : h(String(t))
        }
        function h(t) {
            t = t.replace("#", ""),
        ...
        function v() {
            ...
            if (i.length && i && i !== L) {
                var o;
                o = isNaN(i) ? e(t).find('[data-anchor="' + i + '"]') : e(".pp-section").eq(i - 1),
                l(o)
            }
        }
        function g(e) {
        ...
        function k() {
            B.get(0).addEventListener ? (B.get(0).removeEventListener("mousewheel", w, !1),
            B.get(0).removeEventListener("wheel", w, !1)) : B.get(0).detachEvent("onmousewheel", w)
        }
        function C() {
            B.get(0).addEventListener ? (B.get(0).addEventListener("mousewheel", w, !1),
            B.get(0).addEventListener("wheel", w, !1)) : B.get(0).attachEvent("onmousewheel", w)
        }
        function j() {
            if (F) {
                var e = _();
                B.off("touchstart " + e.down).on("touchstart " + e.down, A),
                B.off("touchmove " + e.move).on("touchmove " + e.move, Q)
            }
        }
        function S() {
            if (F) {
        ...
        function Q(t) {
            ...
            if (!$(t.target) && E(n)) {
                ...
                !y()) {
                    ...
                    U = o.y,
                    W = o.x,
                    "horizontal" === X.direction && Math.abs(H - W) > Math.abs(q - U) ? Math.abs(H - W) > B.width() / 100 * X.touchSensitivity && (H > W ? x("down", i) : W > H && x("up", i)) : Math.abs(q - U) > B.height() / 100 * X.touchSensitivity && (q > U ? x("down", i) : U > q && x("up", i))
                }
            }
        }
        function $(t, n) {
            n = n || 0;
            var r = e(t).parent();
            return !!(n < X.normalScrollElementTouchThreshold && r.is(X.normalScrollElements)) || n != X.normalScrollElementTouchThreshold && $(r, ++n)
        }
        function I() {
            ...
            for (var n = 0; n < e(".pp-section").length; n++) {
                var r = "";
                if (X.anchors.length && (r = X.anchors[n]),
        ...
        function D(t, n) {
            X.navigation && (e("#pp-nav").find(".active").removeClass("active"),
            t ? e("#pp-nav").find('a[href="#' + t + '"]').addClass("active") : e("#pp-nav").find("li").eq(n).find("a").addClass("active"))
        }
        function O(t) {
            X.menu && (e(X.menu).find(".active").removeClass("active"),
            e(X.menu).find('[data-menuanchor="' + t + '"]').addClass("active"))
        }
        function N() {
            var e, i = t.createElement("p"), o = {
            ...
            for (var a in o)
                i.style[a] !== r && (i.style[a] = "translate3d(1px,1px,1px)",
                e = n.getComputedStyle(i).getPropertyValue(o[a]));
            return t.body.removeChild(i),
            e !== r && e.length > 0 && "none" !== e
        }
        function M() {
            return "vertical" !== X.direction ? "translate3d(-100%, 0px, 0px)" : "translate3d(0px, -100%, 0px)"
        }
        var L, z = e.fn.pagepiling, B = e(this), R = 0, F = "ontouchstart"in n || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, q = 0, H = 0, U = 0, W = 0, V = 600, X = e.extend(!0, {
            direction: "vertical",
            menu: null,
            verticalCentered: !0,
            sectionsColor: [],
        ...
        z.setAllowScrolling = function(e) {
            e ? (z.setMouseWheelScrolling(!0),
            j()) : (z.setMouseWheelScrolling(!1),
            S())
        }
        ,
        ...
        z.moveTo = function(n) {
            var r = "";
            r = isNaN(n) ? e(t).find('[data-anchor="' + n + '"]') : e(".pp-section").eq(n - 1),
            r.length > 0 && l(r)
        }
        ,
        ...
        e(".pp-section").each(function(t) {
            ...
            "undefined" != typeof X.sectionsColor[t] && e(this).css("background-color", X.sectionsColor[t]),
            X.verticalCentered && !e(this).hasClass("pp-scrollable") && o(e(this)),
            J -= 1
        }).promise().done(function() {
            X.navigation && (e("#pp-nav").css("margin-top", "-" + e("#pp-nav").height() / 2 + "px"),
...
$(document).ready(function() {
    ...
    function n(e) {
        c && ($.fn.pagepiling.setAllowScrolling(!1),
        $("#pp-nav ul").hide()),
        ...
        e.find("button.close").eq(0).on("click", function() {
            e.modal("hide"),
            t(e),
            c && ($.fn.pagepiling.setAllowScrolling(!0),
            $("#pp-nav ul").show())
        })
    }
    function r(e) {
    ...
    function l(e, t, r) {
        var i, o, a = localStorage.user_visit;
        a ? (a = JSON.parse(a),
        i = {
            first: a.first,
            last: Date.now(),
    ...
    function s(e, t) {
        ...
        Date.now() - r < 1e3 * e ? n(t) : d.formTracking || (_.each($(".section:not(.section-helper) .wrapper2 form"), function(e) {
            $(e).on("done", function() {
        ...
        if (e)
            ...
            var o = {
              ...
              , i = _.filter(f, function(e) {
                var t, n = e.height() <= o.height;
                return t = n ? e.bottom() <= o.bottom && e.top() >= o.top : e.top() <= o.top && e.bottom() >= o.bottom
            });
        var u = {
            inview: _.filter(i, {
                name: "inview"
            ...
            pagelongview: _.filter(f, {
                name: "pagelongview"
            })[0],
            scrollend: _.filter(f, {
                name: "scrollend"
            })[0],
            doubleerror: _.filter(f, {
                name: "doubleerror"
            })[0],
            hourlyvisit: _.filter(f, {
                name: "hourlyvisit"
            })[0],
            weeklyvisit: _.filter(f, {
                name: "weeklyvisit"
            })[0],
            leadback_hour: _.filter(f, {
                name: "leadback_hour"
            })[0],
            leadback_day: _.filter(f, {
                name: "leadback_day"
            })[0],
            leadback_week: _.filter(f, {
                name: "leadback_week"
            })[0],
            leadback_month: _.filter(f, {
                name: "leadback_month"
            })[0]
        };
        if (!$(".modal:visible").length) {
            if (!e) {
                var c = i.length ? i[0].section : null;
                a(c)
            }
            if (u.inview && n(u.inview.modal),
            u.longview && r(u.longview.modal),
            u.doubleback && (u.doubleback.status ? n(u.doubleback.modal) : d.update.doubleback || (d.update.doubleback = u.doubleback)),
            u.doublecancel && !u.doublecancel.status) {
                ...
                h.length && (_.each(h, function(e) {
                    ...
                    $(e).on("hide.bs.modal", function() {
                        1 === r ? (_.each(h, function(e) {
                            $(e).off("hide.bs.modal").off("done")
                        }),
                        n(u.doublecancel.modal)) : r++
                    }).on("done", function() {
            ...
            if (u.leave && !u.leave.status && (u.leave.status = 1,
            $(document).on("mouseleave", function(e) {
                if (3 != e.which) {
                    var t = document.documentElement.clientWidth - e.pageX > 0;
                    t && ($(document).off("mouseleave"),
                    n(u.leave.modal))
                }
            })),
            u.pagelongview && !u.pagelongview.status && (u.pagelongview.status = 1,
            setTimeout(function() {
            ...
            u.scrollend) {
                var m = $(".section-helper").index(".section") - 1
                  , y = !1;
                if (e)
                    y = m === d.section.index(".section");
                else {
                    var v = $(".section").eq(m).offset().top
                      , g = $(".section").eq(m).height()
            ...
            if (u.doubleerror) {
                ...
                _.each(w, function(e) {
                    var t = 0;
                    $(e).on("error", function() {
                        1 === t ? (_.each(w, function(e) {
                            $(e).off("error")
                        }),
                        $(".modal:visible").find(".close").click(),
                        n(u.doubleerror.modal)) : t++
                    })
                })
            }
    ...
    _.each($(".section"), function(e, t) {
        ...
        _.each(r, function(e, t) {
            ...
            c || _.merge(o, {
                ...
                bottom: function() {
                    return n.outerHeight() + n.offset().top
                }
            });
            var l = !1;
            if ("section" == i && "inview" == o.name) {
                var s = !c && o.bottom() < document.documentElement.clientHeight;
                l = o.section.is($(".section").eq(0)) || s
            }
            if ("page" == i) {
                var u = _.filter(window.plp.events, {
                    type: "section"
                })
                ...
                if ("hourlyvisit" == o.name) {
                    var p = (_.indexOf(d, "weeklyvisit") != -1,
                    "leadback_hour")
                      , h = _.indexOf(d, p) != -1;
                    l = m || h
                }
                ...
                "scrollend" == o.name && (l = _.filter(u, function(e) {
                    return "inview" == e.name && e.section.is(f.last)
                }).length),
                "pagelongview" == o.name && (l = _.filter(u, function(e) {
                    return "longview" == e.name && e.section.is(f.first)
                }).length)
            }
            _.indexOf(a, o.name) != -1 || l ? $(e).parent(".macros-modal").remove() : window.plp.events.push(o)
        })
    });
    var f = window.plp.events;
    c ? (a($(".pp-section.active")),
...
$(function() {
    $(".section-slider").each(function() {
        var e = $(this)
          ...
          , o = e.find("[plp-slider-pagination]").filter(t)
          , a = e.find("[plp-slider-index]").filter(t)
          , l = (e.find(".metahtml > .code").filter(t),
        new Swiper(n.get(0),{
            autoHeight: !1,
            autoplay: {
            ...
            on: {
                slideChange: function() {
                    o.each(function() {
                        $(this).children().filter(".is-active").removeClass("is-active"),
                        $(this).children().eq(l.activeIndex).addClass("is-active")
                    }),
        ...
        r.on("click", function() {
            l.isEnd ? l.slideTo(0) : l.slideNext()
        }),
        i.on("click", function() {
            l.isBeginning ? l.slideTo(l.slides.length - 1) : l.slidePrev()
        }),
        o.children().on("click", function() {
        ...
        l.params.autoHeight && !function s() {
            if (!l.animating && l.slides.length) {
                var e = l.wrapperEl.clientHeight
                  , t = l.slides[l.activeIndex].clientHeight;
                e !== t && l.update(),
                setTimeout(s, 40)
            }
        }()
...
$(function() {
    ...
    $(".widget-before-after").each(function() {
        ...
        r.on("load", _.after(r.length, function() {
            ...
            e() ? n.on("move", b) : "hover" === n.data("trigger") ? (n.on("mousemove", b),
            n.on("mousedown", function(e) {
                e.preventDefault()
            })) : "drag" === n.data("trigger") && n.on("mousedown", function(e) {
                g = $(e.target).closest(i).length ? e.pageX - i.offset().left : 0,
...
$(function() {
    $(".widget-hamburger").each(function() {
        ...
        n.on("click", function() {
            r.is(":animated") || (n.toggleClass("is-collapsed"),
...
$(function() {
    $(".widget-hover").each(function() {
        var e = $(this)
          , t = e.find("[plp-hover]").filter(function() {
          ...
          , l = new Swiper(n.get(0),{
            ...
            on: {
                slideChange: function() {
                    ...
                    o.eq(l.activeIndex).addClass("is-active"),
                    a.text(l.activeIndex + 1)
                }
            }
        });
...
function(e, t, n, r) {
    e(n).ready(function() {
        ...
        e.fn.getCount = function() {
            ...
            i('[data-counter="vk"]') && (e.getJSON("https://vk.com/share.php?act=count&index=1&url=" + encodeURIComponent(location.href) + "&callback=?", function(e) {}),
            t.VK || (VK = {}),
            VK.Share = {
                count: function(t, r) {
            ...
            i('[data-counter="ok"]') && (e.getJSON("https://connect.ok.ru/dk?st.cmd=extLike&uid=1&ref=" + encodeURIComponent(location.href) + "&callback=?", function(e) {}),
            t.ODKL || (ODKL = {}),
...
$(function() {
    $(".widget-tabs").each(function() {
        var e = $(this)
          ...
          , a = e.find("[plp-tabs-index]").filter(t)
          , l = new Swiper(n.get(0),{
            autoHeight: "false" === n.attr("data-fixheight"),
            autoplay: !1,
            allowTouchMove: !1,
            ...
            try {
                ...
                plp.modal = {
                    init: function(e, n) {
                        try {
                            ...
                            e.on("click", function(e) {
                                try {
                                    return r === !1 && (n.appendTo("div.area"),
                                    n.modal({
                                        backdrop: !1,
                                        keyboard: !1,
                                        show: !1
                    ...
                    close: function() {
                        try {
                            var e;
                            return e = _.last(t).modal("hide"),
                            e.find(".macros-video").each(function() {
                                try {
                                    var e;
                ...
                n = location.href.match(/#modal-([a-z0-9]+)/),
                n && plp.modal.openbyid(n[1]),
    ...
    try {
        $(function() {
            try {
                ...
                n = {
                    ru: {
                        error: "Форма успешно отпраленна. Вскоре наши специалисты с вами свяжутся. Благодарим за обращение!",
                        validate: "Пожалуйста заполните форму:",
                        interval: "ÐŸÐ¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð°, Ð¿Ð¾Ð²Ñ‚Ð¾Ñ€Ð¸Ñ‚Ðµ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²ÐºÑƒ Ñ‡ÐµÑ€ÐµÐ· Ð¿Ð°Ñ€Ñƒ ÑÐµÐºÑƒÐ½Ð´.",
                        required: "Поле «%field%» является обязательным для заполнения. Пожалуйста заполните его и повторите отправку формы.",
                        email: "ÐŸÐ¾Ð»Ðµ Â«%field%Â» Ð´Ð¾Ð»Ð¶Ð½Ð¾ ÑÐ¾Ð´ÐµÑ€Ð¶Ð°Ñ‚ÑŒ Ð²Ð°Ñˆ Ð½Ð°ÑÑ‚Ð¾ÑÑ‰Ð¸Ð¹ e-mail Ð°Ð´Ñ€ÐµÑ.",
                        phone: "ÐŸÐ¾Ð»Ðµ Â«%field%Â» Ð´Ð¾Ð»Ð¶Ð½Ð¾ ÑÐ¾Ð´ÐµÑ€Ð¶Ð°Ñ‚ÑŒ Ð¿Ñ€Ð°Ð²Ð¸Ð»ÑŒÐ½Ñ‹Ð¹ Ð½Ð¾Ð¼ÐµÑ€ Ñ‚ÐµÐ»ÐµÑ„Ð¾Ð½Ð°.",
                        number: "ÐŸÐ¾Ð»Ðµ Â«%field%Â» Ð´Ð¾Ð»Ð¶Ð½Ð¾ Ð±Ñ‹Ñ‚ÑŒ Ð¿Ñ€Ð°Ð²Ð¸Ð»ÑŒÐ½Ñ‹Ð¼ Ñ‡Ð¸ÑÐ»Ð¾Ð¼."
                    },
                    am: {
                        error: "Õ€Õ¡ÕµÕ¿Õ¶ Õ¸Ö‚Õ²Õ¡Ö€Õ¯Õ¾Õ¡Õ® Õ¹Õ§, Õ­Õ¶Õ¤Ö€Õ¸Ö‚Õ´ Õ¥Õ¶Ö„ Õ¯Ö€Õ¯Õ«Õ¶ ÖƒÕ¸Ö€Õ±Õ¥Õ¬",
                        validate: "ÕÕ¸Õ²Õ¥Ö€Õ¨ Õ½Õ­Õ¡Õ¬ Õ¥Õ¶ Õ¬Ö€Õ¡ÖÕ¾Õ¡Õ®",
                        interval: "ÕÕ¸Õ²Õ¥Ö€Õ¨ Õ½Õ­Õ¡Õ¬ Õ¥Õ¶ Õ´Õ¸Ö‚Õ¿Ö„Õ¡Õ£Ö€Õ¾Õ¡Õ®: Ô½Õ¶Õ¤Ö€Õ¸Ö‚Õ´ Õ¥Õ¶Ö„ Õ¯Ö€Õ¯Õ«Õ¶ ÖƒÕ¸Ö€Õ±Õ¥Õ¬ Õ´Õ« Ö„Õ¡Õ¶Õ« Õ¾Õ¡Ö€Õ¯ÕµÕ¡Õ¶Õ«Ö",
                        required: "Ô½Õ¶Õ¤Ö€Õ¸Ö‚Õ´ Õ¥Õ¶Ö„ Õ¬Ö€Õ¡ÖÖ€Õ¥Ö„ Â«%field%Â» Õ¿Õ¸Õ²Õ¨, Õ¡ÕµÕ¶ ÕºÕ¡Ö€Õ¿Õ¡Õ¤Õ«Ö€ Õ§",
                        email: "Ô½Õ¶Õ¤Ö€Õ¸Ö‚Õ´ Õ¥Õ¶Ö„ Â«%field%Â» Õ¿Õ¸Õ²Õ¸Ö‚Õ´ Õ£Ö€Õ¡Õ¶ÖÕ¥Õ¬ ÕÕ¥Ö€ Õ«Ö€Õ¡Õ¯Õ¡Õ¶ Õ§Õ¬. ÖƒÕ¸Õ½Õ¿Õ« Õ°Õ¡Õ½ÖÕ¥Õ¶",
                    ...
                    bg: {
                        error: "ÐÐµÑƒÑÐ¿ÐµÑˆÐ½Ð¾ Ð¸Ð·Ð¿Ñ€Ð°Ñ‰Ð°Ð½Ðµ Ð½Ð° Ð·Ð°ÑÐ²ÐºÐ°Ñ‚Ð°!",
                        validate: "Ð“Ñ€ÐµÑˆÐ½Ð¾ Ð·Ð°Ð¿ÑŠÐ»Ð½ÐµÐ½Ð¸ Ð¿Ð¾Ð»ÐµÑ‚Ð°:",
                        interval: "ÐœÐ¾Ð»Ñ, Ð¸Ð·Ð¿Ñ€Ð°Ñ‚ÐµÑ‚Ðµ Ð¾Ñ‚Ð½Ð¾Ð²Ð¾ Ð·Ð°ÑÐ²ÐºÐ°Ñ‚Ð° ÑÐ»ÐµÐ´ Ð½ÑÐºÐ¾Ð»ÐºÐ¾ ÑÐµÐºÑƒÐ½Ð´Ð¸.",
                        required: "ÐŸÐ¾Ð»ÐµÑ‚Ð¾ Â«%field%Â» Ðµ Ð·Ð°Ð´ÑŠÐ»Ð¶Ð¸Ñ‚ÐµÐ»Ð½Ð¾ Ð·Ð° Ð·Ð°Ð¿ÑŠÐ»Ð²Ð°Ð½Ðµ.",
                        email: "ÐŸÐ¾Ð»ÐµÑ‚Ð¾ Â«%field%Â» Ñ‚Ñ€ÑÐ±Ð²Ð° Ð´Ð° ÑÑŠÐ´ÑŠÑ€Ð¶Ð° Ð¸ÑÑ‚Ð¸Ð½ÑÐºÐ¸ÑÑ‚ Ð’Ð¸ Ð¸Ð¼ÐµÐ¹Ð» Ð°Ð´Ñ€ÐµÑ.",
                        phone: "ÐŸÐ¾Ð»ÐµÑ‚Ð¾ Â«%field%Â» Ð·Ð°Ð´ÑŠÐ»Ð¶Ð¸Ñ‚ÐµÐ»Ð½Ð¾ Ñ‚Ñ€ÑÐ±Ð²Ð° Ð´Ð° ÑÑŠÐ´ÑŠÑ€Ð¶Ð° Ð¿Ñ€Ð°Ð²Ð¸Ð»Ð½Ð¸ÑÑ‚ Ð’Ð¸ Ñ‚ÐµÐ»ÐµÑ„Ð¾Ð½ÐµÐ½ Ð½Ð¾Ð¼ÐµÑ€.",
                        number: "ÐŸÐ¾Ð»ÐµÑ‚Ð¾ Â«%field%Â» Ñ‚Ñ€ÑÐ±Ð²Ð° Ð´Ð° ÑÑŠÐ´ÑŠÑ€Ð¶Ð° Ð¿Ñ€Ð°Ð²Ð¸Ð»Ð½Ð¾ Ð¸Ð·Ð¿Ð¸ÑÐ°Ð½Ð¾ Ñ‡Ð¸ÑÐ»Ð¾."
                    },
                    uk: {
                        error: "ÐÐµ Ð²Ð´Ð°Ð»Ð¾ÑÑ Ð²Ñ–Ð´Ð¿Ñ€Ð°Ð²Ð¸Ñ‚Ð¸ Ñ„Ð¾Ñ€Ð¼Ñƒ!",
                        validate: "ÐÐµÐ¿Ñ€Ð°Ð²Ð¸Ð»ÑŒÐ½Ð¾ Ð·Ð°Ð¿Ð¾Ð²Ð½ÐµÐ½Ñ– Ð¿Ð¾Ð»Ñ:",
                        interval: "Ð‘ÑƒÐ´ÑŒ Ð»Ð°ÑÐºÐ°, Ð¿Ð¾Ð²Ñ‚Ð¾Ñ€Ñ–Ñ‚ÑŒ Ð²Ñ–Ð´Ð¿Ñ€Ð°Ð²ÐºÑƒ Ñ‡ÐµÑ€ÐµÐ· Ð¿Ð°Ñ€Ñƒ ÑÐµÐºÑƒÐ½Ð´",
                        required: "ÐŸÐ¾Ð»Ðµ Â«%field%Â» Ð¾Ð±Ð¾Ð²'ÑÐ·ÐºÐ¾Ð²Ð¾ Ð´Ð»Ñ Ð·Ð°Ð¿Ð¾Ð²Ð½ÐµÐ½Ð½Ñ.",
                        email: "ÐŸÐ¾Ð»Ðµ Â«%field%Â» Ð¿Ð¾Ð²Ð¸Ð½Ð½Ð¾ Ð¼Ñ–ÑÑ‚Ð¸Ñ‚Ð¸ Ð²Ð°Ñˆ ÑÐ¿Ñ€Ð°Ð²Ð¶Ð½Ñ–Ð¹ e-mail Ð°Ð´Ñ€ÐµÑÑƒ.",
                        phone: "ÐŸÐ¾Ð»Ðµ Â«%field%Â» Ð¿Ð¾Ð²Ð¸Ð½Ð½Ð¾ Ð¼Ñ–ÑÑ‚Ð¸Ñ‚Ð¸ Ð¿Ñ€Ð°Ð²Ð¸Ð»ÑŒÐ½Ð¸Ð¹ Ð½Ð¾Ð¼ÐµÑ€ Ñ‚ÐµÐ»ÐµÑ„Ð¾Ð½Ñƒ.",
                        number: "ÐŸÐ¾Ð»Ðµ Â«%field%Â» Ð¼Ð°Ñ” Ð±ÑƒÑ‚Ð¸ Ð¿Ñ€Ð°Ð²Ð¸Ð»ÑŒÐ½Ð¸Ð¼ Ñ‡Ð¸ÑÐ»Ð¾Ð¼."
                    },
                    md: {
                        error: "Форма успешно отпраленна. Вскоре наши специалисты с вами свяжутся. Благодарим за обращение!",
                        validate: "Пожалуйста заполнит форму:",
                        interval: "ÐŸÐ¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð°, Ð¿Ð¾Ð²Ñ‚Ð¾Ñ€Ð¸Ñ‚Ðµ Ð¾Ñ‚Ð¿Ñ€Ð°Ð²ÐºÑƒ Ñ‡ÐµÑ€ÐµÐ· Ð¿Ð°Ñ€Ñƒ ÑÐµÐºÑƒÐ½Ð´.",
                        required: "Поле «%field%» является обязательным для заполнения. Пожалуйста заполните его и повторите отправку формы.",
                        email: "ÐŸÐ¾Ð»Ðµ Â«%field%Â» Ð´Ð¾Ð»Ð¶Ð½Ð¾ ÑÐ¾Ð´ÐµÑ€Ð¶Ð°Ñ‚ÑŒ Ð²Ð°Ñˆ Ð½Ð°ÑÑ‚Ð¾ÑÑ‰Ð¸Ð¹ e-mail Ð°Ð´Ñ€ÐµÑ.",
                        phone: "ÐŸÐ¾Ð»Ðµ Â«%field%Â» Ð´Ð¾Ð»Ð¶Ð½Ð¾ ÑÐ¾Ð´ÐµÑ€Ð¶Ð°Ñ‚ÑŒ Ð¿Ñ€Ð°Ð²Ð¸Ð»ÑŒÐ½Ñ‹Ð¹ Ð½Ð¾Ð¼ÐµÑ€ Ñ‚ÐµÐ»ÐµÑ„Ð¾Ð½Ð°.",
                    ...
                    el: {
                        error: "Î— Ï†ÏŒÏÎ¼Î± Î´ÎµÎ½ ÏƒÏ„Î¬Î»Î¸Î·ÎºÎµ!",
                        validate: "Î¤Î± Ï€ÎµÎ´Î¯Î± Î´ÎµÎ½ ÏƒÏ…Î¼Ï€Î»Î·ÏÏŽÎ¸Î·ÎºÎ±Î½ ÏƒÏ‰ÏƒÏ„Î¬:",
                        interval: "Î Î±ÏÎ±ÎºÎ±Î»ÏŽ, Ï€ÏÎ¿ÏƒÏ€Î±Î¸Î®ÏƒÏ„Îµ Î¾Î±Î½Î¬ ÏƒÎµ Î¼ÎµÏÎ¹ÎºÎ¬ Î´ÎµÏ…Ï„ÎµÏÏŒÎ»ÎµÏ€Ï„Î±.",
                        required: "Î¤Î¿ Ï€ÎµÎ´Î¯Î¿ Â«%field%Â» Î±Ï€Î±Î¹Ï„ÎµÎ¯Ï„Î±Î¹.",
                        email: "Î¤Î¿ Ï€ÎµÎ´Î¯Î¿ Â«%field%Â» Ï€ÏÎ­Ï€ÎµÎ¹ Î½Î± Ï€ÎµÏÎ¹Î»Î±Î¼Î²Î¬Î½ÎµÎ¹ Ï„Î·Î½ Ï€ÏÎ±Î³Î¼Î±Ï„Î¹ÎºÎ® Î´Î¹ÎµÏÎ¸Ï…Î½ÏƒÎ· e-mail ÏƒÎ±Ï‚.",
                        phone: "Î¤Î¿ Ï€ÎµÎ´Î¯Î¿ Â«%field%Â» Ï€ÏÎ­Ï€ÎµÎ¹ Î½Î± Ï€ÎµÏÎ¹Î­Ï‡ÎµÎ¹ Ï„Î¿Î½ ÏƒÏ‰ÏƒÏ„ÏŒ Î±ÏÎ¹Î¸Î¼ÏŒ Ï„Î·Î»ÎµÏ†ÏŽÎ½Î¿Ï….",
                        number: "Î¤Î¿ Ï€ÎµÎ´Î¯Î¿ Â«%field%Â» Î¸Î± Ï€ÏÎ­Ï€ÎµÎ¹ Î½Î± ÎµÎ¯Î½Î±Î¹ Î¿ ÏƒÏ‰ÏƒÏ„ÏŒÏ‚ Î±ÏÎ¹Î¸Î¼ÏŒÏ‚."
                    },
                    lt: {
                    ...
                    kz: {
                        ...
                        validate: "ÒšÐ°Ñ‚Ðµ Ñ‚Ð¾Ð»Ñ‚Ñ‹Ñ€Ñ‹Ð»Ò“Ð°Ð½:",
                        interval: "Ó¨Ñ‚Ñ–Ð½ÐµÐ¼Ñ–Ð·, Ð±Ñ–Ñ€Ð½ÐµÑˆÐµ ÑÐµÐºÑƒÐ½Ð´Ñ‚Ð°Ð½ ÑÐ¾Ò£ Ñ‚Ð°Ò“Ñ‹ Ò›Ð°Ð¹Ñ‚Ð°Ð»Ð°Ð¿ Ð±Ð°Ð¹Ò›Ð°Ð¿ ÐºÓ©Ñ€Ñ–Ò£Ñ–Ð·.",
                        required: '"%field%" Ñ‚Ð¾Ð»Ñ‚Ñ‹Ñ€ÑƒÑ‹Ò£Ñ‹Ð· Ð¼Ñ–Ð½Ð´ÐµÑ‚Ñ‚Ñ–.',
                        email: '"%field%" ÑÑ–Ð·Ð´Ñ–Ò£ e-mail Ð°Ð´Ñ€ÐµÑÑ–Ò£Ñ–Ð· ÑˆÑ‹Ð½ Ð±Ð¾Ð»ÑƒÑ‹ Ñ‚Ð¸Ñ–Ñ.',
                        phone: '"%field%" Ñ‚ÐµÐ»ÐµÑ„Ð¾Ð½ Ð½Ð¾Ð¼ÐµÑ€Ñ–Ò£Ñ–Ð·Ð´Ñ– Ð´Ò±Ñ€Ñ‹ÑÑ‚Ð°Ð¿ Ð¶Ð°Ð·ÑƒÑ‹Ò£Ñ‹Ð·Ð´Ñ‹ ÑÒ±Ñ€Ð°Ð½Ð°Ð¼Ñ‹Ð·.',
                        number: '"%field%" ÑÐ°Ð½Ð´Ñ‹ Ð´Ò±Ñ€Ñ‹ÑÑ‚Ð°Ð¿ Ð¶Ð°Ð·ÑƒÑ‹Ò£Ñ‹Ð·Ð´Ñ‹ ÑÒ±Ñ€Ð°Ð½Ð°Ð¼Ñ‹Ð·.'
                    },
                    "zh-CN": {
                        error: "å¡«å¥½çš„è¡¨æ ¼å‘ä¸äº†",
                        validate: "è¿™äº›å­—æ®µå¡«å†™æ— æ³•",
                        interval: "è¯·ç¨ç­‰å†å‘é€",
                        required: "è¯¥â€œ%field%â€ å­—æ®µå¿…é¡»å¡«å¥½",
                        email: "è¯¥â€œ%field%â€ å­—æ®µå¿…é¡»å«çœŸå®žçš„ç”µå­é‚®ä»¶",
                        phone: "è¯¥â€œ%field%â€ å­—æ®µå¿…é¡»å¡«å†™æœ‰æ•ˆæ‰‹æœºå·ç ",
                        number: "è¯¥â€œ%field%â€ å­—æ®µå¿…é¡»å¡«å†™æ­£ç¡®çš„å·ç "
                    },
                    ge: {
                        error: "áƒ¤áƒáƒ áƒ›áƒ áƒáƒ  áƒ’áƒáƒ˜áƒ’áƒ–áƒáƒ•áƒœáƒ!",
                        validate: "áƒ¨áƒ”áƒ›áƒ“áƒ”áƒ’áƒ˜ áƒ•áƒ”áƒšáƒ”áƒ‘áƒ˜ áƒáƒ áƒáƒ¡áƒ¬áƒáƒ áƒáƒ“ áƒáƒ áƒ˜áƒ¡ áƒ¨áƒ”áƒ•áƒ¡áƒ”áƒ‘áƒ£áƒšáƒ˜:",
                        interval: "áƒ’áƒáƒ˜áƒ›áƒ”áƒáƒ áƒ”áƒ— áƒ’áƒáƒ’áƒ–áƒáƒ•áƒœáƒ˜áƒ¡",
                        required: "áƒáƒ› áƒ•áƒ”áƒšáƒ˜áƒ¡ Â«%field%Â» áƒ¨áƒ”áƒ•áƒ¡áƒ”áƒ‘áƒ áƒáƒ£áƒªáƒ˜áƒšáƒ”áƒ‘áƒ”áƒšáƒ˜áƒ.",
                        email: "áƒ”áƒ¡ áƒ•áƒ”áƒšáƒ˜ Â«%field%Â» áƒ£áƒœáƒ“áƒ áƒ¨áƒ”áƒ˜áƒªáƒáƒ•áƒ“áƒ”áƒ¡ áƒ—áƒ¥áƒ•áƒ”áƒœáƒ˜ áƒœáƒáƒ›áƒ“áƒ•áƒ˜áƒšáƒ˜ áƒ”áƒš-áƒ¤áƒáƒ¡áƒ¢áƒ˜áƒ¡ áƒ›áƒ˜áƒ¡áƒáƒ›áƒáƒ áƒ—áƒ¡.",
                        phone: "áƒ”áƒ¡ áƒ•áƒ”áƒšáƒ˜ Â«%field%Â» áƒ£áƒœáƒ“áƒ áƒ¨áƒ”áƒ˜áƒªáƒáƒ•áƒ“áƒ”áƒ¡ áƒ áƒ”áƒáƒšáƒ£áƒ áƒáƒ“ áƒáƒ áƒ¡áƒ”áƒ‘áƒ£áƒš áƒ¢áƒ”áƒšáƒ”áƒ¤áƒáƒœáƒ˜áƒ¡ áƒœáƒáƒ›áƒ”áƒ áƒ¡.",
                        number: "áƒáƒ› áƒ•áƒ”áƒšáƒ¨áƒ˜ Â«%field%Â» áƒ£áƒœáƒ“áƒ áƒ˜áƒ§áƒáƒ¡ áƒ¡áƒ¬áƒáƒ áƒ˜ áƒ áƒ˜áƒªáƒ®áƒ•áƒ˜."
                    },
                    ro: {
                        error: "Formularul nu a fost trimis!",
                        validate: "CÃ¢mp completat incorect:",
                        interval: "VÄƒ rugÄƒm sÄƒ Ã®ncercaÈ›i peste cÃ¢teva secunde.",
                        required: "CÃ¢mp Â«%field%Â» obligator.",
                        email: "CÃ¢mpul Â«%field%Â» trebuie sÄƒ conÈ›inÄƒ adresa Dvs. e-mail veridicÄƒ.",
                        phone: "CÃ¢mpul Â«%field%Â» trebuie sÄƒ conÈ›inÄƒ numÄƒrul Dvs. de telefon veridic.",
                        number: "CÃ¢mpul Â«%field%Â»trebuie sÄƒ conÈ›inÄƒ o datÄƒ veridicÄƒ."
                    },
                    lv: {
                    ...
                    he: {
                        error: "×ª×•×¤×¡ × ×©×œ×— ×œ×œ× ×”×¦×œ×—×”",
                        validate: "×”×©×“×•×ª ×ž×ž×•×œ××™× ×œ× × ×›×•×Ÿ",
                        interval: "×× × ×œ×©×œ×•×— ×©×•×‘ ×‘×¢×•×“ ×›×ž×” ×©× ×™×•×ª",
                        required: '×—×™×™×‘ ×œ×ž×œ××•×ª ×©×“×” "%field%"',
                        email: '×©×“×” "%field%" ×—×™×™×‘ ×œ×›×œ×•×œ ××ª ×›×ª×•×‘×ª ×”×“×•××¨ ×”××œ×§×˜×¨×•× ×™ ×”××ž×™×ª×™×ª ×©×œ×š',
                        phone: '×©×“×” "%field%" ×—×™×™×‘ ×œ×›×œ×•×œ ×ž×¡×¤×¨ ×˜×œ×¤×•×Ÿ × ×›×•×Ÿ',
                        number: '×©×“×” "%field%" ×¦×¨×™×š ×œ×”×™×•×ª ×”×ž×¡×¤×¨ ×”× ×›×•×Ÿ'
                    }
                },
                ...
                r = function(e, t, n) {
                    try {
                        var r;
                        return "xs" === plp.screen ? (r = e,
                        t && (r += "\n" + t),
                        alert(r),
                        void (n && n())) : Modernizr.cssanimations ? swal({
                            title: e,
                            text: t || null,
                            type: "error"
                        }, n) : swal({
                ...
                $("form.form").each(function() {
                    try {
                        ...
                        return p = $(this),
                        m = p.data("form"),
                        y = p.closest("[data-item]").data("item") || [],
                        v = p.closest('[data-modal="cart"]').length ? plp.cart.list : [],
                        h = p.data("fields"),
                        g = {
                            hit: {
                                page_id: a,
                                    ...
                                    return (n = function() {
                                        try {
                                            return t.find(":file").on("change", function() {
                                                try {
                                                    var e, o;
                                                    for (o = t.find(":file").closest(".pseudo"),
                                                    o.clone().insertAfter(o),
                                                    e = $("<form>"),
                                                    i = 0,
                                                    attributes = o[0].attributes; i < attributes.length; i++)
                                                    ...
                                                    e.ajaxSubmit({
                                                        beforeSend: function() {
                                                            try {
                                                                return t.find("span.state").text("Ð—Ð°Ð³Ñ€ÑƒÐ·ÐºÐ°...")
                                                            } catch (e) {
                                                        ...
                                                        uploadProgress: function(e, n, r, i) {
                                                            try {
                                                                return t.find("span.state").text("Ð—Ð°Ð³Ñ€ÑƒÐ·ÐºÐ°... " + i + "%")
                                                            } catch (o) {
                                                        ...
                                                        success: function(r) {
                                                            try {
                                                                ...
                                                                t.find("span.state").text("Ð¤Ð°Ð¹Ð» Ð·Ð°Ð³Ñ€ÑƒÐ¶ÐµÐ½"),
                                                                e.remove(),
                                                                n()
                                                            } catch (i) {
                                                        ...
                                                        error: function(i) {
                                                            try {
                                                                return r("ÐžÑˆÐ¸Ð±ÐºÐ° Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐ¸!", 400 === i.status ? i.responseText : null),
                                                                t.find("span.state").text("Ð’Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ Ñ„Ð°Ð¹Ð»..."),
                                                                t.data("result", null),
                                                                e.remove(),
                                                                n()
                                                            } catch (o) {
                        ...
                        p.find("[data-placeholder]").each(function() {
                            try {
                                ...
                                e.on("blur", function(n) {
                                    try {
                                        if ("" === e.val())
                                            return e.val(t).data("placeholder", !0)
                                    } catch (r) {
                        ...
                        p.on("submit", function(e) {
                            try {
                                ...
                                f.each(function(e) {
                                    try {
                                        var n;
                                        if ("checkbox-input" === g.fields[e].type ? g.fields[e].value = $(this).find("input").prop("checked") ? c : u : "radio-list" === g.fields[e].type ? g.fields[e].value = $(this).find("[type=radio]:checked").val() || "" : "select-menu" === g.fields[e].type ? g.fields[e].value = $(this).find("select").val() : "hidden" === g.fields[e].type ? (g.fields[e].name = g.fields[e].id,
                                        g.fields[e].value = $(this).find("input").val()) : "file" === g.fields[e].type ? g.fields[e].value = $(this).data("result") || "" : (n = $(this).find(".form-control").data("placeholder"),
                                        g.fields[e].value = n ? "" : $(this).find(".form-control").val()),
                                        g.fields[e].required && "" === g.fields[e].value && d.push(t.required.replace("%field%", g.fields[e].name)),
                                        "" === g.fields[e].value)
                                            return;
                                        if ("email" !== g.fields[e].type || /.+@.+\..+/.test(g.fields[e].value) || d.push(t.email.replace("%field%", g.fields[e].name)),
                                ...
                                _.each(g.fields, function(e) {
                                    try {
                                        var t;
                                        if ("" === b[e.type] && (b[t = e.type] || (b[t] = e.value)),
                                        !b.fields[e.name])
                                ...
                                y = function(e, i, a) {
                                    try {
                                        ...
                                        "msg" === m.after ? o(_.template(m.msg, e), null) : "url" === m.after ? location.href = _.template(m.url, e) : "addhtml" === m.after ? $("body").append(_.template(m.addhtml, e)) : "pay" === m.after ? e.url ? location.href = e.url : e.form && $(e.form).hide().appendTo("body").submit() : "msg+url" === m.after ? o(_.template(m.msg, e), null, function() {
                                            try {
                                        ...
                                        }) : "js" === m.after && (c = "(function () { var time = <%= time %>; var name = '<%- name %>'; var email = '<%- email %>'; var phone = '<%- phone %>'; var count = '<%- count %>'; var fields = <%= JSON.stringify(fields) %>; var item = <%= JSON.stringify(item) %>; var items = <%= JSON.stringify(items) %>; var send = <%= JSON.stringify(send) %>;" + m.js + "})();",
                                ...
                                function () {
                                    ...
                                    if (g.fields.length === 2) {
                                        ...
                                        postData = {
                                            time: new Date(),
                                            name: g.fields[0].value,
                                            phone: g.fields[1].value
                                        }
                                    }
                                    else {
                                        postData = {
                                            time: new Date(),
                                            vid: g.fields[0].value,
                                            name: g.fields[1].value,
                                            phone: g.fields[2].value,
                                            email: g.fields[3].value
                                                }
                                         }
                                    console.log(postData)
                                    let newFeedKey = firebase.database().ref().child('feeds').push().key;
                                    let updates = {};
            ...
            try {
                ...
                $('[data-action="formscroll"]').each(function() {
                    try {
                        ...
                        r = t.prevAll(".section"),
                        n = t.nextAll(".section"),
                        e = i.hasClass("btn") ? i : i.find(".btn"),
                        e.on("click", function() {
                            try {
                                var e, i, o;
                                if (i = n.find(".form:visible").first(),
                                1 === i.length)
                                ...
                                if (e = t.find(".form:visible").first(),
                                1 === e.length)
                                    return $("html, body").animate({
                ...
                $(document).on("click", 'a[href^="#"]', function(e) {
                    try {
                        ...
                        if (n = $($(this).attr("href")),
                        n.length)
                            return i = n.offset().top,
                            t.length && (i -= t.height()),
                            $("html").hasClass("pp") ? (r = n.closest(".pp-section").index(".pp-section"),
                            r = n.closest(".pp-section").index(".pp-section"),
                            $.fn.pagepiling.moveTo(r + 1)) : $("html,body").animate({
                                scrollTop: i
                            }, {
                                duration: 1e3,
            ...
            try {
                ...
                o = e.length; i < o; i++)
                    ...
                    l.push(function(t) {
                        try {
                            var r, i, o, l;
                            if (o = document.createElement("span"),
                            ...
                            r = function() {
                                try {
                                    if (o && o.offsetWidth !== l && (++a,
                                    o.parentNode.removeChild(o),
                                    o = null),
                                    a >= e.length && (i && clearInterval(i),
                                    a === e.length))
                                        return n(),
                                        !0
                                } catch (t) {
                        ...
                        try {
                            ...
                            n) {
                                ...
                                o <= a)
                                    ...
                                    e.removeClass("fixed"),
                                    n = !1
                            } else if (a = e.offset().top,
                            o > a)
                                return t.css("height", e.height()).insertAfter(e),
                                e.css("opacity", r),
                                e.addClass("fixed"),
                                n = !0
                        } catch (l) {
            ...
            try {
                return $(".node[data-bgvideo]").each(function() {
                    try {
                        ...
                        return e = $(this),
                        t = e.data("bgvideo"),
                        plp.lazy.add(e.removeAttr("data-bgvideo"), function(n) {
                            try {
                                var r;
                ...
                if ("xs" !== window.plp.screen)
                    ...
                    $("div.area").pagepiling({
                        ...
                        onLeave: function(e, t, n) {
                            try {
                                var r;
                                if ($("div.area").trigger("leave", [t]),
                                $(".pp-section").eq(e - 1).find(".wow").addClass("wow-finished"),
                                $(".pp-section").eq(t - 1).find(".wow:not(.wow-finished)").removeAttr("style").css({
                                    visibility: "hidden"
                                }),
                                r = function(e, t) {
                                    try {
                ...
                return $(".section-helper .cookieWarning").each(function() {
                    try {
                        ...
                        !t)
                            ...
                            e.find("i, .moreInfo").on("click", function() {
                                try {
...
function() {
    try {
        $(function() {
            try {
                var e, t, n, r;
                if (t = $(".widget-comments-fb"),
                !t.length)
                    return;
                if (e = t.find(".fb"),
                e.length)
                    return n = "true" === e.attr("data-joint"),
                    r = "http://" + location.host.replace(/^www\./, ""),
                    n || (r += "/" + location.pathname),
                    e.attr("data-href", r),
                    e.attr("data-width", e.width()),
                    $("head").append('<meta property="fb:app_id" content="' + e.data("apiid") + '"/>'),
...
function() {
    try {
        ...
        $(function() {
            try {
                var t, n, r, i, o, a;
                if (n = $(".widget-comments-vk"),
                !n.length)
                    return;
                if (t = n.find(".vk"),
                t.length && t.data("apiid"))
            ...
            try {
                ...
                $(".widget-countdown").each(function() {
                    try {
                        ...
                        l = n.data("vals"),
                        a = new Date,
                        "full" === l.type ? (l.full_date.day++,
                        i = new Date(l.full_date.year,l.full_date.month,l.full_date.day,l.full_time.hour,l.full_time.minute)) : "month" === l.type ? (l.month_day++,
                        i = new Date(a.getFullYear(),a.getMonth(),l.month_day,l.month_time.hour,l.month_time.minute),
                        i.getTime() < a.getTime() && (i = new Date(a.getFullYear(),a.getMonth() + 1,l.month_day,l.month_time.hour,l.month_time.minute))) : "week" === l.type ? (r = l.week_day - e(a.getDay()),
                        i = new Date(a.getFullYear(),a.getMonth(),a.getDate() + r,l.week_time.hour,l.week_time.minute),
                        i.getTime() < a.getTime() && (r = 7 - e(a.getDay()) + l.week_day,
                        i = new Date(a.getFullYear(),a.getMonth(),a.getDate() + r,l.week_time.hour,l.week_time.minute))) : "day" === l.type ? (i = new Date(a.getFullYear(),a.getMonth(),a.getDate(),l.day_time.hour,l.day_time.minute),
                        i.getTime() < a.getTime() && (i = new Date(a.getFullYear(),a.getMonth(),a.getDate() + 1,l.day_time.hour,l.day_time.minute))) : "fake" === l.type && (o = [l.fake_days, l.fake_time.hour, l.fake_time.minute].join(":"),
                        $.cookie(o) ? i = new Date(1 * $.cookie(o)) : (i = new Date(a.getFullYear(),a.getMonth(),a.getDate() + l.fake_days,a.getHours() + l.fake_time.hour,a.getMinutes() + l.fake_time.minute),
                        $.cookie(o, i.getTime(), {
                            expires: 365,
                            path: "/"
                        }))),
                        n.countdown({
                            ...
                            layout: n.html(),
                            format: "DHMS",
                            timezone: "fake" === l.type || "default" === l.timezone ? null : l.timezone
                        }),
